				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<form action="<?php echo site_url('r_outbound'); ?>" method="post" enctype="multipart/form-data">
										...
										<div class="col-xs-12 col-sm-3">
											<div class="form-group">
												<label for="ss_id" class="control-label">Doc ID</label>
												<select class="chosen-select form-control" id="ss_id" name="ss_id" data-placeholder="Please Choose">
													<option value="">Please Choose</option>
													<?php
													$is_continue_ext = true;
													$get_data_ext = $this->M_library_database->DB_GET_DATA_SEARCH_OUTBOUND_REPORT();
											...
											<div>
												<table id="tb_item" name="tb_item" class="table table-striped table-bordered">
													...
													<tbody>
														...
														//-----------------------------------------------------------------------------------------------//
														if($is_continue){
															$get_data = $this->M_library_database->DB_GET_DATA_SEARCH_DETAIL_OUTBOUND_REPORT($ss_date_from,$ss_date_to,$ss_id);
														...
														?>
														<!-- Table Row -->
														<form action="<?php echo site_url('C_r_outbound/detail'); ?>" method="post" enctype="multipart/form-data">
															<tr>
																<td><?php echo $index; ?></td>
																<td><?php echo $data_row->PTOD_ID; ?></td>
																<td><?php echo $data_row->PTOD_TGL_KIRIM; ?></td>
																<td><?php echo $data_row->DR_ID; ?></td>
																<td><?php echo $data_row->PTOD_DO_NO; ?></td>
																<td><?php echo $data_row->PTOD_ORDER_NO; ?></td>
																<td><?php echo $data_row->PTOD_TRUCK_TYPE; ?></td>
																<td><?php echo $data_row->EI_ID; ?></td>
																<td><?php echo $data_row->PTOD_SEAL_NO; ?></td>
																<td><?php echo $data_row->PTOD_QTY_TOTAL; ?></td>
																<td></td>
																<td>
																	<input type="hidden" id="ss_doc_id" name="ss_doc_id" value="<?php echo $data_row->PTOD_ID; ?>" required="required"/>
																	<button type="submit" id="btn_detail" name="btn_detail" class="btn btn-info btn-sm"><i class="fa fa-search"></i></button>
																</td>
															</tr>
														</form>
														<!-- Table Row -->
							...
							<div class="row">
								<div class="col-xs-12">
									<p>
										...
										<form action="<?php echo site_url('C_r_outbound/data_download'); ?>" method="post" enctype="multipart/form-data">
