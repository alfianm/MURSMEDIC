				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													$is_continue = true;
													//-----------------------------------------------------------------------------------------------//
													$get_data = $this->M_library_database->DB_GET_DATA_ALL_PRODUCT_OUTBOUND_APPROVE_SUMMARY();
													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																data-su_id="<?php echo $data_row->PTOD_DO_NO; ?>"
							...
							<div class="row">
								<div class="col-xs-12">
									<form action="<?php echo site_url('C_o_delivery_note_status/data_download'); ?>" method="post" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="form-group">
									<label for="su_id_lastest" class="col-xs-12 col-sm-3 control-label" style="text-align:left">DO No (Lastest)</label>
