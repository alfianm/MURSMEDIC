			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Product Sample</li>
					</ul>
				</div>
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<form action="<?php echo site_url('q_sample'); ?>" method="post" enctype="multipart/form-data">
											...
											<div>
												<table id="tb_item" name="tb_item" class="table table-striped table-bordered">
													...
													if (isset($_POST['btn_search'])) {
														...
														//-----------------------------------------------------------------------------------------------//
													if ($is_continue) {
														$get_data = $this->M_library_database->DB_GET_DATA_SEARCH_SAMPLE($ss_date_from, $ss_date_to);
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body">
												<form class="form-horizontal" method="post" action="<?php echo base_url("C_q_data/all_data_quarantine"); ?>">
												<div class="row">
														<input type="hidden" id="sv_id" name="sv_id" class="form-control sv_id" required="required" readonly="readonly"/>
													
														<input type="hidden" id="sv_total" name="sv_total" class="form-control sv_total" required="required" onkeyup="hitung()" readonly/>
															
													<div class="col-xs-12">
														<div class="form-group">
																<label for="repack" class="col-xs-12 col-sm-3 control-label" 	style="text-align:left">Repack</label>
															<div class="col-xs-12 col-sm-9">
																<input type="text" id="repack" onkeyup="hitung()" name="repack" class="form-control repack" required="required" value="0"/>
															</div>
														</div>
													</div>
													<div class="col-xs-12">	
														<div class="form-group">
															<label for="sample" class="col-xs-12 col-sm-3 control-label" style="text-align:left">Sample</label>
															<div class="col-xs-12 col-sm-9">
																<input type="text" id="sample" onkeyup="hitung()" name="sample" class="form-control sample" required="required" value="0"/>
															</div>
														</div>
													</div>
													<div class="col-xs-12">	
														<div class="form-group">
															...
															<div class="col-xs-12 col-sm-9">
																<input type="text" id="destroy" onkeyup="hitung()" name="destroy" class="form-control destroy" required="required" value="0"/>
															</div>
														</div>
													</div>
													<div class="col-xs-12">	
														<div class="form-group">
																<label for="return" class="col-xs-12 col-sm-3 control-label" style="text-align:left">Return</label>
															<div class="col-xs-12 col-sm-9">
																<input type="text" id="return" onkeyup="hitung()" name="return" class="form-control return" required="required" value="0"/>
															</div>
														</div>
													</div>
													<div class="col-xs-12">
														<div class="form-group">
															...
															<div class="col-xs-12 col-sm-9">
																<input type="text" id="total" name="total" class="form-control sv_total" required="required" readonly/>
															</div>
														</div>
													</div>
												</div>
