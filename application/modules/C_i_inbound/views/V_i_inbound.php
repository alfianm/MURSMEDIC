...
//-----------------------------------------------------------------------------------------------//
$is_continue_approve_summary = true;
$get_data_approve_summary = $this->M_library_database->DB_GET_DATA_ALL_PRODUCT_INBOUND_APPROVE_SUMMARY();
if(empty($get_data_approve_summary)||$get_data_approve_summary==""){
	$is_continue_approve_summary = false;
}

$get_rack = $this->M_library_database->DB_GET_DATA_ALL_RACK_BY_STORAGE();
if(empty($get_rack)||$get_rack==""){
	$get_rack_product = false;
}
//-----------------------------------------------------------------------------------------------//
?>
<!------------------------------------------------------------------------------------------------->
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<form action="<?php echo site_url('i_inbound'); ?>" method="post" enctype="multipart/form-data">
										<div class="col-xs-12 col-sm-3">
											<div class="form-group">
												...
												<select class="chosen-select form-control" id="ss_doc_id" name="ss_doc_id" data-placeholder="Please Choose">
													...
													<?php
													if($is_continue_approve_summary){
														foreach($get_data_approve_summary as $data_row_approve_summary){
															$PTID_ID = $data_row_approve_summary->PTID_ID;
													?>
							...
							?>
							<form method="POST" action="<?php echo site_url("C_i_inbound/update"); ?>">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<?php
											...
											$SR_EMAIL = "";
											$SR_ADDRESS = "";
											$SR_ADDRESS_MANUFACTURING = "";
											$PTID_PO_NO = "";
											$PTID_PACKING_LIST_NO = "";
											$PTID_PIB_NO = "";
											$PTID_INVOICE_NO = "";
											$FR_ID = "";
											$FR_NAME = "";
											...
											if($is_continue){
												foreach($get_data as $data_row_all_product_inbound_single){
													...
													$SR_ID = $data_row_all_product_inbound_single->SR_ID;
													$SR_NAME = $data_row_all_product_inbound_single->SR_NAME;
													$SR_PHONE = $data_row_all_product_inbound_single->SR_PHONE;
													$SR_EMAIL = $data_row_all_product_inbound_single->SR_EMAIL;
													$SR_ADDRESS = $data_row_all_product_inbound_single->SR_ADDRESS;
													$SR_ADDRESS_MANUFACTURING = $data_row_all_product_inbound_single->SR_ADDRESS_MANUFACTURING;
													$PTID_PO_NO = $data_row_all_product_inbound_single->PTID_PO_NO;
													$PTID_PACKING_LIST_NO = $data_row_all_product_inbound_single->PTID_PACKING_LIST_NO;
													$PTID_PIB_NO = $data_row_all_product_inbound_single->PTID_PIB_NO;
													$PTID_INVOICE_NO = $data_row_all_product_inbound_single->PTID_INVOICE_NO;
													$FR_ID = $data_row_all_product_inbound_single->FR_ID;
													$FR_NAME = $data_row_all_product_inbound_single->FR_NAME;
													$FR_PHONE = $data_row_all_product_inbound_single->FR_PHONE;
													$FR_EMAIL = $data_row_all_product_inbound_single->FR_EMAIL;
													$FR_ADDRESS = $data_row_all_product_inbound_single->FR_ADDRESS;
													$PTID_CONTAINER_NO = $data_row_all_product_inbound_single->PTID_CONTAINER_NO;
													$PTID_CONTAINER_PLAT_NO = $data_row_all_product_inbound_single->PTID_CONTAINER_PLAT_NO;
													$PTID_SEAL_NO = $data_row_all_product_inbound_single->PTID_SEAL_NO;
													$UR_ID = $data_row_all_product_inbound_single->UR_ID;
													$UR_NAME = $data_row_all_product_inbound_single->UR_NAME;
													$UR_PHONE = $data_row_all_product_inbound_single->UR_PHONE;
													$UR_EMAIL = $data_row_all_product_inbound_single->UR_EMAIL;
													$GT_ID = $data_row_all_product_inbound_single->GT_ID;
													$PTID_STATUS = $data_row_all_product_inbound_single->PTID_STATUS;
													$PTID_APP_BY = $data_row_all_product_inbound_single->PTID_APP_BY;
													$PTID_QTY_TOTAL = $data_row_all_product_inbound_single->PTID_QTY_TOTAL;
															...
															<div>
																<table id="tb_item" name="tb_item" class="table table-striped table-bordered">
																	...
																	<tbody>
																		...
																		<?php
																		if($is_continue){
																			$get_data_product_detail = $this->M_library_database->DB_GET_DATA_ALL_PRODUCT_INBOUND_DETAIL_BY_PRODUCT($PTID_ID);
																		...
																		if($is_continue){
																			...
																			foreach($get_data_product_detail as $data_row_product_detail){
																				...
																				$si_product_id = $data_row_product_detail->PTID_ID;
																				...
																				$si_product_detail_label = $data_row_product_detail->PTIDDL_LABEL;
																				$si_product_detail_no = $data_row_product_detail->PTIDDL_NO;
																				$si_product_detail_expired = $data_row_product_detail->PTIDDL_EXPIRED;
																				$si_product_detail_qty_good = $data_row_product_detail->PTIDDL_QTY_GOOD;
																				$si_product_storage = $data_row_product_detail->SE_ID;
																				$si_product_receive = $data_row_product_detail->PTIDDL_DATE;
																		?>
																		<tr id='addr<?php echo $index_row; ?>'>
																			...
																			<td>
																				<input type="hidden" name="si_rk_awal[]" value="<?php echo $si_product_detail_rack; ?>">
																				<input type="hidden" name="si_product_detail_id[]" value="<?php echo $si_product_detail_id; ?>">
																				<input type="hidden" name="si_product_id[]" value="<?php echo $si_product_id; ?>">
																				<input type="text" name="si_product_detail_name[]" value="<?php echo $si_product_detail_name; ?>">
																				<input type="text" name="si_product_receive[]" value="<?php echo $si_product_receive; ?>">
																				<input type="text" name="si_product_detail_qty_good[]" value="<?php echo $si_product_detail_qty_good; ?>">
																				<input type="text" name="si_product_detail_no[]" value="<?php echo $si_product_detail_no; ?>">
																				<input type="hidden" name="si_label[]" value="<?= $si_product_detail_label; ?>">
																				<input type="hidden" name="si_detail_id[]" value="<?= $si_detail_id; ?>">
																				<select class="chosen-select form-control rack_id" id="rack_id[]" name="rack_id[]" data-placeholder="Please Choose" required="required">
																				<option value="">Please Choose</option>
																				<option selected value="<?= $si_product_detail_rack ?>"><?= $si_product_detail_rack ?> : <?= $si_product_storage ?></option>
																				<?php
																				$is_continue_ext = true;
																				$get_data_ext = $this->M_library_database->DB_GET_DATA_ALL_RACK();
																				...
																				if($is_continue_ext){
																					foreach($get_data_ext as $data_row_ext){
																						$RK_ID = $data_row_ext->RK_ID;
																						$SE_ID = $data_row_ext->SE_ID;
																				?>
																				<option value="<?php echo $RK_ID; ?>"><?php echo $RK_ID; ?> : <?= $SE_ID ?></option>
																				<?php
																					}
																				}
																				?>
																			...
																			<!-- <td><?php echo $si_product_detail_rack; ?></td> -->
																			<td><?php echo $si_product_detail_no; ?></td>
																			<td><?php echo $si_product_detail_expired; ?></td>
																			<td><?php echo $si_product_detail_qty_good; ?></td>
