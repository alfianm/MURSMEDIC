...
// print_r($si_product_id);die;
//-----------------------------------------------------------------------------------------------//
// $get_data_all_product_inbound_single = $this->M_library_database->DB_GET_DATA_ALL_PRODUCT_INBOUND_SINGLE($si_product_id);
// print_r($get_data_all_product_inbound_single);die;
		...
		<div class="main-content">
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<a href="<?php echo site_url('i_approve_data'); ?>" class="btn btn-success btn-xs"><i class="ace-icon fa fa-home"></i></a>
							&nbsp;
					...
					<div id='printMe'>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<?php
							$get_data_product_detail = $this->M_library_database->DB_GET_DATA_ALL_PRODUCT_INBOUND_DETAIL_BY_PRODUCT($si_product_id[0]);
							// print_r($get_data_product_detail);die;
							foreach ($get_data_product_detail as $data_row_product_detail) {
								$si_product_detail_label = $data_row_product_detail->PTIDDL_LABEL;

								$array_data_label = explode("[]", $si_product_detail_label);

								$label_detail_id = $array_data_label[0];
								$label_detail_name = $array_data_label[1];
								$label_rack = $array_data_label[2];
								$label_date_receive = $array_data_label[3];
								$label_product_qty_good = $array_data_label[4];
								$label_barcode = $array_data_label[5];

								$img_name = $label_barcode . ".png";
								$path_file = FCPATH . '/template/barcode/' . $img_name;
								$this->M_library_module->barcode($filepath = $path_file, $text = $label_barcode, $size = "100", $orientation = "horizontal", $code_type = "code128", $print = true, $SizeFactor = 1);
									//BARCODE
								?>
								<div class="col-xs-6 col-sm-6 pricing-box" style="margin-bottom:30px;">
									<div class="widget-box widget-color-dark">
										<div class="widget-header">
											<h4 class="widget-title bigger lighter">Produk : <?php echo $label_detail_id; ?></h4>
											<br />
											<h4 class="widget-title bigger lighter">Nama : <?php echo $label_detail_name; ?></h4>
										</div>
										<div class="widget-body">
											<div class="widget-main">
												<h1 class="widget-title bigger lighter center"><?php echo $label_rack; ?></h1>
												<hr />
												<h4 class="widget-title bigger lighter">Tgl Terima : <?php echo $label_date_receive; ?></h4>
												<h4 class="widget-title bigger lighter">Qty : <?php echo $label_product_qty_good; ?></h4>
												<br />
												<div class="table-responsive">          
													<table class="table">
														<tbody>
															<tr>
																<td>
																	<h4 class="widget-title bigger lighter center">
																		<img class="" src="<?php echo base_url('template/barcode/' . $img_name); ?>" />
																	</h4>
																</td>
																<td>
																	<h4 class="widget-title bigger lighter">Desc</h4>
																</td>
															</tr>
														</tbody>
													</table>
