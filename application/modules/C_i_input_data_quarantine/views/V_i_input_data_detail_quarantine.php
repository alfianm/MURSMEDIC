...
foreach ($get_data_supplier as $data_row_supplier) {
	...
	$si_supplier_address = $data_row_supplier->SR_ADDRESS;
	$si_supplier_address_manufacturing = $data_row_supplier->SR_ADDRESS_MANUFACTURING;
}
...
foreach ($get_data_forwarder as $data_row_forwarder) {
	...
	$si_forwarder_address = $data_row_forwarder->FR_ADDRESS;
}
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form action="<?php echo site_url('C_i_input_data_quarantine/data_insert_detail_q'); ?>" method="post" enctype="multipart/form-data">
								<!------------------------------------------------------------------------------------------------->					
								<div class="row">
									<div class="col-xs-12">
										...
										<div class="col-xs-12 col-sm-4">
											...
											<br />
											Packing List No : <?php echo $si_packing_list_no; ?>
											<br />
											PIB No : <?php echo $si_pib_no; ?>
										</div>
										<div class="col-xs-12 col-sm-4">
												...
												<div class="table-responsive">
													<div>
														<table id="tb_item" name="tb_item" class="table table-striped table-bordered">
															...
															$PT_ID = $_POST['si_product_id'];
															$PT_NAME = $_POST['si_product_name'];
															$PT_UNIT = $_POST['si_product_unit'];
															$PT_TYPE = $_POST['si_product_type'];
															$PT_IS_MANUFDATE = $_POST['si_product_ismanufdate'];
															$QTY = $_POST['si_product_qty'];
															$EXPIRED = $_POST['si_product_expired'];
