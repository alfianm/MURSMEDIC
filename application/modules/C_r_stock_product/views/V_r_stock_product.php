				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<form action="<?php echo site_url('r_stock_product'); ?>" method="post" enctype="multipart/form-data">
										<div class="col-xs-12 col-sm-3">
											<div class="form-group">
												<label for="ss_id" class="control-label">Product</label>
										...
										<div class="col-xs-12 col-sm-3">
											<div class="form-group">
												<label for="ss_category" class="control-label">Product Category</label>
							...
							<div class="row">
								<div class="col-xs-12">
									<p>
										...
										<form action="<?php echo site_url('C_r_stock_product/data_download'); ?>" method="post" enctype="multipart/form-data">
