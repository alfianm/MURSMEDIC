...
$get_data_approve_summary = $this->M_library_database->DB_GET_DATA_ALL_PRODUCT_OUTBOUND_APPROVE_SUMMARY();
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<form action="<?php echo site_url('o_delivery_note'); ?>" method="post" enctype="multipart/form-data">
												...
												<select class="chosen-select form-control" id="ss_doc_id" name="ss_doc_id" data-placeholder="Please Choose">
													...
													if($is_continue_approve_summary){
														foreach($get_data_approve_summary as $data_row_approve_summary){
															$PTOD_ID = $data_row_approve_summary->PTOD_ID;
													?>
								...
								<?php
									...
									if($is_continue){
										foreach($get_data as $data_row_all_product_outbound_single){
											$PTOD_ID = $data_row_all_product_outbound_single->PTOD_ID;
											$PTOD_DATE = $data_row_all_product_outbound_single->PTOD_DATE;
											$PTOD_TGL_KIRIM = $data_row_all_product_outbound_single->PTOD_TGL_KIRIM;
											$DR_ID = $data_row_all_product_outbound_single->DR_ID;
											$DR_NAME = $data_row_all_product_outbound_single->DR_NAME;
											$DR_PHONE = $data_row_all_product_outbound_single->DR_PHONE;
											$DR_EMAIL = $data_row_all_product_outbound_single->DR_EMAIL;
											$DR_ADDRESS = $data_row_all_product_outbound_single->DR_ADDRESS;
											$DR_ADDRESS_SHIPPING = $data_row_all_product_outbound_single->DR_ADDRESS_SHIPPING;
											$PTOD_DO_NO = $data_row_all_product_outbound_single->PTOD_DO_NO;
											$PTOD_ORDER_NO = $data_row_all_product_outbound_single->PTOD_ORDER_NO;
											$PTOD_TRUCK_TYPE = $data_row_all_product_outbound_single->PTOD_TRUCK_TYPE;
											$PTOD_TRUCK_NO = $data_row_all_product_outbound_single->PTOD_TRUCK_NO;
											$PTOD_DRIVER = $data_row_all_product_outbound_single->PTOD_DRIVER;
											$EI_ID = $data_row_all_product_outbound_single->EI_ID;
											$EI_NAME = $data_row_all_product_outbound_single->EI_NAME;
											$EI_PHONE = $data_row_all_product_outbound_single->EI_PHONE;
											$EI_EMAIL = $data_row_all_product_outbound_single->EI_EMAIL;
											$EI_ADDRESS = $data_row_all_product_outbound_single->EI_ADDRESS;
											$PTOD_SEAL_NO = $data_row_all_product_outbound_single->PTOD_SEAL_NO;
											$UR_ID = $data_row_all_product_outbound_single->UR_ID;
											$UR_NAME = $data_row_all_product_outbound_single->UR_NAME;
											$UR_PHONE = $data_row_all_product_outbound_single->UR_PHONE;
											$UR_EMAIL = $data_row_all_product_outbound_single->UR_EMAIL;
											$GT_ID = $data_row_all_product_outbound_single->GT_ID;
											$PTOD_STATUS = $data_row_all_product_outbound_single->PTOD_STATUS;
											$PTOD_APP_BY = $data_row_all_product_outbound_single->PTOD_APP_BY;
											$PTOD_QTY_TOTAL = $data_row_all_product_outbound_single->PTOD_QTY_TOTAL;
										}
									}
								?>
								<!------------------------------------------------------------------------------------------------->
														...
														<div class="widget-box">
															<div class="widget-body">
																<div class="widget-main">
																	Tgl Kirim : <?php echo $PTOD_TGL_KIRIM; ?>
																	<br />
																	DN Number : <?php echo $PTOD_DO_NO; ?>
																</div>
															</div>
														</div>
													</div>
												...
												<div class="row">
													...
													<div class="col-xs-12 col-sm-4">
														<div class="widget-box">
															<div class="widget-body">
																<div class="widget-main">
																	Order No : <?php echo $PTOD_ORDER_NO; ?>
																	<br />
																	Truck Type : <?php echo $PTOD_TRUCK_TYPE; ?>
																	<br />
																	Truck No : <?php echo $PTOD_TRUCK_NO; ?>
																	<br />
																	Driver : <?php echo $PTOD_DRIVER; ?>
																	<br />
																	Ekspedisi : <?php echo "(".$EI_ID.")"." ".$EI_NAME; ?>
																	<br />
																	Seal No : <?php echo $PTOD_SEAL_NO; ?>
																</div>
															</div>
														</div>
													</div>
															...
															<div>
																<table id="tb_item" name="tb_item" class="table table-striped table-bordered">
																	...
																	<tbody>
																		...
																		<?php
																		if($is_continue){
																			$get_data_product_detail = $this->M_library_database->DB_GET_DATA_ALL_PRODUCT_OUTBOUND_DETAIL_BY_PRODUCT($PTOD_ID);
																		...
																		if($is_continue){
																			...
																			foreach($get_data_product_detail as $data_row_product_detail){
																				...
																				$si_product_detail_qty_good = $data_row_product_detail->PTODDL_QTY_GOOD;
																		?>
																		...
																		<?php
																				...
																				$PT_WEIGHT = $data_row_product_detail->PT_WEIGHT;
																				$PT_VOLUME = $data_row_product_detail->PT_VOLUME;
																				$sum_weight+=($PT_WEIGHT*$si_product_detail_qty_good);
																				$sum_volume+=($PT_VOLUME*$si_product_detail_qty_good);
																				$sum_total+=$si_product_detail_qty_good;
																			}
																		}
																		?>
																		<!------------------------------------------------------------------------------------------------->
										...
										<div class="row">
											...
											<div class="col-xs-12 col-sm-4">
												<div class="widget-box">
													<div class="widget-body">
														<div class="widget-main">
															WEIGHT : <?php echo $sum_weight; ?> KG
															<br />
															VOLUME : <?php echo $sum_volume; ?> CBM
															<br />
															TOTAL : <?php echo $sum_total; ?>
														</div>
													</div>
												</div>
											</div>
