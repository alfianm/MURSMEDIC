...
<body class="no-skin">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<form action="<?php echo site_url('q_data'); ?>" method="post" enctype="multipart/form-data">
											...
											<div>
												<table id="tb_item" name="tb_item" class="table table-striped table-bordered">
													...
													if (isset($_POST['btn_search'])) {
														...
														//-----------------------------------------------------------------------------------------------//
													if ($is_continue) {
														$get_data = $this->M_library_database->DB_GET_DATA_SEARCH_QUARANTINE($ss_date_from, $ss_date_to);
													...
													if ($is_continue) {
														...
														<tr>
															...
															<td><?php echo $data_row->PTQE_ID; ?></td>
															<td><?php echo $data_row->PTID_ID; ?></td>
															<td><?php echo $data_row->PT_ID; ?></td>
															<td><?php echo $data_row->PTQE_NAME; ?></td>
															<td><?php echo $data_row->PTQE_DATE; ?></td>
															<td><?php echo $data_row->PTQE_NO; ?></td>
															<td><?php echo $data_row->PTQE_QTY; ?></td>
															<td><?php echo $data_row->PTQE_EXPIRED; ?></td>
															<td><?php echo $data_row->PTQE_STATUS; ?></td>
															<td>
															<button class="tooltip-info btn_view" data-toggle="modal" data-target="#modal-repack" data-rel="tooltip" title="REPACK" 
															data-repack_id="<?php echo $data_row->PTQE_ID; ?>"
															data-repack_ptid_id="<?php echo $data_row->PTID_ID; ?>"
															data-repack_pt_id="<?php echo $data_row->PT_ID; ?>"
															data-sv_name="<?php echo $data_row->PTQE_NAME; ?>"
															data-sv_date="<?php echo $data_row->PTQE_DATE; ?>"
															data-sv_no="<?php echo $data_row->PTQE_NO; ?>"
															data-repack_total="<?php echo $data_row->PTQE_QTY; ?>"
															data-sv_expired="<?php echo $data_row->PTQE_EXPIRED; ?>"><i class="ace-icon fa fa-recycle bigger-110"></i></button>
															<button class="tooltip-info btn_view" data-toggle="modal" data-target="#modal-sample" data-rel="tooltip" title="SAMPLE" 
															data-sample_id="<?php echo $data_row->PTQE_ID; ?>"
															data-sample_ptid_id="<?php echo $data_row->PTID_ID; ?>"
															data-sample_pt_id="<?php echo $data_row->PT_ID; ?>"
															data-sample_name="<?php echo $data_row->PTQE_NAME; ?>"
															data-sample_date="<?php echo $data_row->PTQE_DATE; ?>"
															data-sample_no="<?php echo $data_row->PTQE_NO; ?>"
															data-sample_total="<?php echo $data_row->PTQE_QTY; ?>"
															data-sample_expired="<?php echo $data_row->PTQE_EXPIRED; ?>"><i class="ace-icon fa fa-book bigger-110"></i></button>
															<button class="tooltip-info btn_view" data-toggle="modal" data-target="#modal-destroy" data-rel="tooltip" title="DESTROY" 
															data-sv_id="<?php echo $data_row->PTQE_ID; ?>"
															data-sv_pt_id="<?php echo $data_row->PT_ID; ?>"
															data-sv_name="<?php echo $data_row->PTQE_NAME; ?>"
															data-sv_date="<?php echo $data_row->PTQE_DATE; ?>"
															data-sv_no="<?php echo $data_row->PTQE_NO; ?>"
															data-sv_total="<?php echo $data_row->PTQE_QTY; ?>"
															data-sv_expired="<?php echo $data_row->PTQE_EXPIRED; ?>"><i class="ace-icon fa fa-trash bigger-110"></i></button>
															<button class="tooltip-info btn_view" data-toggle="modal" data-target="#modal-return" data-rel="tooltip" title="RETURN"
															data-return_id="<?php echo $data_row->PTQE_ID; ?>"
															data-return_ptid_id="<?php echo $data_row->PTID_ID; ?>"
															data-return_pt_id="<?php echo $data_row->PT_ID; ?>"
															data-return_name="<?php echo $data_row->PTQE_NAME; ?>"
															data-return_date="<?php echo $data_row->PTQE_DATE; ?>"
															data-return_no="<?php echo $data_row->PTQE_NO; ?>"
															data-return_total="<?php echo $data_row->PTQE_QTY; ?>"
															data-return_expired="<?php echo $data_row->PTQE_EXPIRED; ?>"><i class="ace-icon fa fa-recycle bigger-110"></i></button>
															</td>
														</tr>
														<!-- Table Row -->
							...
							<!-- Download -->
							<!-- Modal Repack -->
							<div id="modal-repack" class="modal" tabindex="-1">
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal">&times;</button>
												<h4 class="blue bigger">FORM REPACK</h4>
											</div>
											<div class="modal-body">
												<form class="form-horizontal" method="post" action="<?php echo base_url("C_i_input_data_quarantine/repack"); ?>">
												<div class="row">
													...
													<div class="col-xs-12">
														<div class="form-group">
																<label for="repack" class="col-xs-12 col-sm-3 control-label" 	style="text-align:left">Repack</label>
															<div class="col-xs-12 col-sm-9">
																<input type="text" id="repack" onkeyup="hitung()" name="repack" class="form-control repack" required="required" value="0" autocomplete="off" />
															</div>
														</div>
													</div>
													<div class="col-xs-12">
														<div class="form-group">
																<label for="total" class="col-xs-12 col-sm-3 control-label" 	style="text-align:left">Total QTY</label>
															<div class="col-xs-12 col-sm-9">
																<input type="text" id="total_1" name="total_1" class="form-control repack_total" required="required" readonly/>
															</div>
														</div>
													</div>
												</div>
							...
							<!-- Modal Sample -->
							<div id="modal-sample" class="modal" tabindex="-1">
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal">&times;</button>
												<h4 class="blue bigger">FORM SAMPLE</h4>
											</div>
											<div class="modal-body">
												<form class="form-horizontal" method="post" action="<?php echo base_url("C_q_data/Sample"); ?>">
												<div class="row">
														<input type="hidden" id="sample_id" name="sample_id" class="form-control sample_id" required="required" readonly="readonly"/>
														<input type="hidden" id="sample_pt_id" name="sample_pt_id" class="form-control sample_pt_id" required="required" readonly="readonly"/>
														<input type="hidden" id="sample_ptid_id" name="sample_ptid_id" class="form-control sample_ptid_id" required="required" readonly="readonly"/>
														<input type="hidden" id="sample_name" name="sample_name" class="form-control sample_name" required="required" readonly="readonly"/>
														<input type="hidden" id="sample_no" name="sample_no" class="form-control sample_no" required="required" readonly="readonly"/>
														<input type="hidden" id="sample_total" name="sample_total" class="form-control sample_total" required="required" onkeyup="hitung2()" readonly/>
														<input type="hidden" id="sample_expired" name="sample_expired" class="form-control sample_expired" required="required" readonly="readonly"/>
														
													<div class="col-xs-12">
														<div class="form-group">
																<label for="repack" class="col-xs-12 col-sm-3 control-label" 	style="text-align:left">Sample</label>
															<div class="col-xs-12 col-sm-9">
																<input type="text" id="sample" onkeyup="hitung2()" name="sample" class="form-control sample" required="required" value="0" autocomplete="off" />
															</div>
														</div>
													</div>
													<div class="col-xs-12">
														<div class="form-group">
																<label for="total" class="col-xs-12 col-sm-3 control-label" 	style="text-align:left">Total QTY</label>
															<div class="col-xs-12 col-sm-9">
																<input type="text" id="total_2" name="total_2" class="form-control sample_total" required="required" readonly/>
															</div>
														</div>
													</div>
												</div>
							...
							<!-- Modal Destroy -->
							<div id="modal-destroy" class="modal" tabindex="-1">
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal">&times;</button>
												<h4 class="blue bigger">FORM DESTROY</h4>
											</div>
											<div class="modal-body">
												<form class="form-horizontal" method="post" action="<?php echo base_url("C_q_data/Destroy"); ?>">
												<div class="row">
														<input type="hidden" id="sv_id" name="sv_id" class="form-control sv_id" required="required" readonly="readonly"/>
													
														<input type="hidden" id="sv_total" name="sv_total" class="form-control sv_total" required="required" onkeyup="hitung3()" readonly/>
														<input type="hidden" id="sv_expired" name="sv_expired" class="form-control sv_expired" required="required" readonly="readonly"/>
														
													<div class="col-xs-12">
														<div class="form-group">
																<label for="destroy" class="col-xs-12 col-sm-3 control-label" style="text-align:left">Destroy</label>
															<div class="col-xs-12 col-sm-9">
																<input type="text" id="destroy" onkeyup="hitung3()" name="destroy" class="form-control destroy" required="required" value="0" autocomplete="off" />
															</div>
														</div>
													</div>
													<div class="col-xs-12">
														<div class="form-group">
																<label for="total" class="col-xs-12 col-sm-3 control-label" 	style="text-align:left">Total QTY</label>
															<div class="col-xs-12 col-sm-9">
																<input type="text" id="total_3" name="total_3" class="form-control sv_total" required="required" readonly/>
															</div>
														</div>
													</div>
												</div>
							...
							<!-- Modal Return -->
							<div id="modal-return" class="modal" tabindex="-1">
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal">&times;</button>
												<h4 class="blue bigger">FORM RETURN</h4>
											</div>
											<div class="modal-body">
												<form class="form-horizontal" method="post" action="<?php echo base_url("C_q_data/C_return"); ?>">
												<div class="row">
														<input type="hidden" id="return_id" name="return_id" class="form-control return_id" required="required" readonly="readonly"/>
														<input type="hidden" id="return_pt_id" name="return_pt_id" class="form-control return_pt_id" required="required" readonly="readonly"/>
														<input type="hidden" id="return_ptid_id" name="return_ptid_id" class="form-control return_ptid_id" required="required" readonly="readonly"/>
														<input type="hidden" id="return_name" name="return_name" class="form-control return_name" required="required" readonly="readonly"/>
														<input type="hidden" id="return_date" name="return_date" class="form-control return_date" required="required" readonly="readonly"/>
														<input type="hidden" id="return_no" name="return_no" class="form-control return_no" required="required" readonly="readonly"/>
														<input type="hidden" id="return_total" name="return_total" class="form-control return_total" required="required" onkeyup="hitung4()" readonly/>
														<input type="hidden" id="return_expired" name="return_expired" class="form-control return_expired" required="required" readonly="readonly"/>
														
													<div class="col-xs-12">
														<div class="form-group">
																<label for="repack" class="col-xs-12 col-sm-3 control-label" 	style="text-align:left">Return</label>
															<div class="col-xs-12 col-sm-9">
																<input type="text" id="return" onkeyup="hitung4()" name="return" class="form-control return" required="required" value="0" autocomplete="off" />
															</div>
														</div>
													</div>
													<div class="col-xs-12">
														<div class="form-group">
																<label for="total" class="col-xs-12 col-sm-3 control-label" 	style="text-align:left">Total QTY</label>
															<div class="col-xs-12 col-sm-9">
																<input type="text" id="total_4" name="total_4" class="form-control return_total" required="required" readonly/>
															</div>
														</div>
													</div>
												</div>
	...
	<script type="text/javascript">
		...
		$(document).on( "click", '.btn_view',function(e) {
			...
			var sample_total = $(this).data('sample_total');
			var sample_ptid_id = $(this).data('sample_ptid_id');
			var sample_pt_id = $(this).data('sample_pt_id');
			var sample_name = $(this).data('sample_name');
			var sample_date = $(this).data('sample_date');
			var sample_no = $(this).data('sample_no');
			var sample_expired = $(this).data('sample_expired');

			var return_id = $(this).data('return_id');
			var return_total = $(this).data('return_total');
			var return_ptid_id = $(this).data('return_ptid_id');
			var return_pt_id = $(this).data('return_pt_id');
			var return_name = $(this).data('return_name');
			var return_date = $(this).data('return_date');
			var return_no = $(this).data('return_no');
			var return_expired = $(this).data('return_expired');

			var repack_id = $(this).data('repack_id');
			var repack_ptid_id = $(this).data('repack_ptid_id');
			var repack_total = $(this).data('repack_total');
			var repack_pt_id = $(this).data('repack_pt_id');

			$(".repack_id").val(repack_id);
			$(".repack_ptid_id").val(repack_ptid_id);
			$(".repack_pt_id").val(repack_pt_id);
			$(".repack_total").val(repack_total);
			...
			$(".sample_total").val(sample_total);
			$(".sample_pt_id").val(sample_pt_id);
			$(".sample_ptid_id").val(sample_ptid_id);
			$(".sample_name").val(sample_name);
			$(".sample_date").val(sample_date);
			$(".sample_no").val(sample_no);
			$(".sample_expired").val(sample_expired);

			$(".return_id").val(return_id);
			$(".return_total").val(return_total);
			$(".return_pt_id").val(return_pt_id);
			$(".return_ptid_id").val(return_ptid_id);
			$(".return_name").val(return_name);
			$(".return_date").val(return_date);
			$(".return_no").val(return_no);
			$(".return_expired").val(return_expired);
		});

	function hitung() {
		var a = $("#repack_total").val();
		var b = $("#repack").val();
		f = a - b;
		$("#total_1").val(f);
	}
