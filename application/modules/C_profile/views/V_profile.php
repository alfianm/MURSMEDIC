									...
									<div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
										<div class="inline position-relative">
											<a class="user-title-label dropdown-toggle" data-toggle="dropdown">
												<span class="white"><?php echo $SESSION_NAME; ?></span>
											</a>
										</div>
									</div>
							...
							<div class="col-xs-12 col-sm-9">
								<div class="center">
									...
									<span class="btn btn-app btn-sm btn-yellow no-hover">
										<span class="line-height-1 bigger-170"> U </span>
									</span>
									<span class="btn btn-app btn-sm btn-pink no-hover">
										<span class="line-height-1 bigger-170"> R </span>
									</span>
									<span class="btn btn-app btn-sm btn-grey no-hover">
										<span class="line-height-1 bigger-170"> S </span>
									</span>
								</div>
								...
								<div class="profile-user-info profile-user-info-striped">
									<form class="form-horizontal" action="<?php echo site_url('C_profile/data_update'); ?>" method="post" enctype="multipart/form-data">
										<div class="profile-info-row">
											<div class="profile-info-name"> Userid </div>
											<div class="profile-info-value">
												<input type="text" id="su_id" name="su_id" class="form-control" value="<?php echo $SESSION_ID; ?>" readonly="readonly"/>
											</div>
										</div>
	
										<?php
										$get_data = $this->M_library_database->DB_GET_DATA_ALL_USER_SINGLE($SESSION_ID);
										foreach($get_data as $data_row){
											$UR_ID = $data_row->UR_ID;
											$UR_PASSWORD = $data_row->UR_PASSWORD;
											$UR_NAME = $data_row->UR_NAME;
											$UR_PHONE = $data_row->UR_PHONE;
											$UR_EMAIL = $data_row->UR_EMAIL;
											$GT_ID = $data_row->GT_ID;
										}
										?>
										<div class="profile-info-row">
											<div class="profile-info-name"> Password </div>
											<div class="profile-info-value">
												<input type="password" id="su_password" name="su_password" class="form-control" value="<?php echo $UR_PASSWORD; ?>" maxlength="150" autocomplete="off" onkeyup="auto_caps(this)" required="required"/>
											</div>
										</div>
										...
										<div class="profile-info-row">
											...
											<div class="profile-info-value">
												<input type="text" id="su_name" name="su_name" class="form-control" value="<?php echo $UR_NAME; ?>" maxlength="150" autocomplete="off" onkeyup="auto_caps(this)" required="required"/>
											</div>
										</div>
										...
										<div class="profile-info-row">
											...
											<div class="profile-info-value">
												<input type="text" id="su_phone" name="su_phone" class="form-control" value="<?php echo $UR_PHONE; ?>" maxlength="15" autocomplete="off" onkeydown="numbers_only(event)" required="required"/>
											</div>
										</div>
										...
										<div class="profile-info-row">
											...
											<div class="profile-info-value">
												<input type="email" id="su_email" name="su_email" class="form-control" value="<?php echo $UR_EMAIL; ?>" maxlength="150" autocomplete="off" required="required"/>
											</div>
										</div>
	
										<div class="profile-info-row">
											<div class="profile-info-name"> Grant </div>
											<div class="profile-info-value">
												<input type="text" id="su_grant" name="su_grant" class="form-control" value="<?php echo $GT_ID; ?>" readonly="readonly"/>
											</div>
										</div>
