				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<form action="<?php echo site_url('i_summary'); ?>" method="post" enctype="multipart/form-data">
										...
										<div class="row">
											<div class="col-xs-12">
												<div class="col-xs-12 col-sm-4">
													<p>
														Doc ID : <?php echo $PTID_ID; ?>
														<br />
														Userid : <?php echo $UR_ID; ?>
														<br />											
													</p>
												</div>
												<div class="col-xs-12 col-sm-4">
													...
													<br />
													Packing List No : <?php echo $PTID_PACKING_LIST_NO; ?>
													<br />
													PIB No : <?php echo $PTID_PIB_NO; ?>
												</div>
												<div class="col-xs-12 col-sm-4">
													...
													<br />
													Container No : <?php echo $PTID_CONTAINER_NO; ?>
													<br />
													Truck Plat No : <?php echo $PTID_CONTAINER_PLAT_NO; ?>
													<br />
													Seal No : <?php echo $PTID_SEAL_NO; ?>
												</div>
											</div>
										</div>
