...
<body class="no-skin">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<form action="<?php echo site_url('md_grant'); ?>" method="post" enctype="multipart/form-data">
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													//-----------------------------------------------------------------------------------------------//
													if($is_continue){
														$get_data = $this->M_library_database->DB_GET_DATA_SEARCH_GRANT($ss_id);
													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																data-sv_id="<?php echo $data_row->GT_ID; ?>"
																...
																data-su_id="<?php echo $data_row->GT_ID; ?>"
																...
																data-sd_id="<?php echo $data_row->GT_ID; ?>"
							...
							<div class="row">
								<div class="col-xs-12">
									<form action="<?php echo site_url('C_md_grant/data_download'); ?>" method="post" enctype="multipart/form-data">
	...
	<div id="modal-form-new" class="modal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form-horizontal" action="<?php echo site_url('C_md_grant/data_insert'); ?>" method="post" enctype="multipart/form-data">
	...
	<div id="modal-form-update" class="modal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form-horizontal" action="<?php echo site_url('C_md_grant/data_update'); ?>" method="post" enctype="multipart/form-data">
	...
	<div id="modal-form-delete" class="modal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form-horizontal" action="<?php echo site_url('C_md_grant/data_delete'); ?>" method="post" enctype="multipart/form-data">
