			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<form action="<?php echo site_url('C_i_input_data/data_insert'); ?>" method="post" enctype="multipart/form-data">
							<!------------------------------------------------------------------------------------------------->					
							<div class="row">
								<div class="col-xs-12">
												...
												<div>
													<table id="tb_item" name="tb_item" class="table table-striped table-bordered">
														...
														<tbody>
															<tr id='addr0'>
																<td>1</td>
<td><select id="si_product_id[]" name="si_product_id[]" class="form-control" required="required" onChange="product_info(this);"></select></td>
<td><input type="text" class="form-control si_product_name" required="required" readonly="readonly"/></td>
<td><input type="text" class="form-control si_product_unit" required="required" readonly="readonly"/></td>
<td><input type="text" class="form-control si_product_type" required="required" readonly="readonly"/></td>
<td><input type="text" class="form-control si_product_ismanufdate" required="required" readonly="readonly"/></td>
<td><input type="text" id="si_product_qty[]" name="si_product_qty[]" class="form-control" maxlength="20" autocomplete="off" onkeydown="numbers_only(event)" required="required"/></td>
																<td>
																	<div class="input-group">
