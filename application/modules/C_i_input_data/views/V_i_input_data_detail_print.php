		...
		<div class="main-content">
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<a href="<?php echo site_url('i_input_data'); ?>" class="btn btn-success btn-xs"><i class="ace-icon fa fa-home"></i></a>
							&nbsp;
