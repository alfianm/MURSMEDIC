				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<form action="<?php echo site_url('r_inbound'); ?>" method="post" enctype="multipart/form-data">
										...
										<div class="col-xs-12 col-sm-3">
											<div class="form-group">
												...
												<select class="chosen-select form-control" id="ss_id" name="ss_id" data-placeholder="Please Choose">
													...
													$get_data_ext = $this->M_library_database->DB_GET_DATA_SEARCH_INBOUND_REPORT();
											...
											<div>
												<table id="tb_item" name="tb_item" class="table table-striped table-bordered">
													...
													<tbody>
														...
														//-----------------------------------------------------------------------------------------------//
														if($is_continue){
															$get_data = $this->M_library_database->DB_GET_DATA_SEARCH_DETAIL_INBOUND_REPORT($ss_date_from,$ss_date_to,$ss_id);
														...
														?>
														<!-- Table Row -->
														<form action="<?php echo site_url('C_r_inbound/detail'); ?>" method="post" enctype="multipart/form-data">
															<tr>
																<td><?php echo $index; ?></td>
																<td><?php echo $data_row->PTID_ID; ?></td>
																<td><?php echo $data_row->PTID_TGL_TERIMA; ?></td>
																<td><?php echo $data_row->SR_ID; ?></td>
																<td><?php echo $data_row->PTID_PO_NO; ?></td>
																<td><?php echo $data_row->PTID_PIB_NO; ?></td>
																<td><?php echo $data_row->FR_ID; ?></td>
																<td><?php echo $data_row->PTID_QTY_TOTAL; ?></td>
																<td>
																	<input type="hidden" id="ss_doc_id" name="ss_doc_id" value="<?php echo $data_row->PTID_ID; ?>" required="required"/>
							...
							<div class="row">
								<div class="col-xs-12">
									<p>
										...
										<form action="<?php echo site_url('C_r_inbound/data_download'); ?>" method="post" enctype="multipart/form-data">
