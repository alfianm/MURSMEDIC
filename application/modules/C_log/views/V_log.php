				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<form action="<?php echo site_url('log'); ?>" method="post" enctype="multipart/form-data">
										<div class="col-xs-12 col-sm-3">
											<div class="form-group">
												<label for="ss_date_from" class="control-label">Date From</label>
												<div class="input-group">
													<input class="form-control date-picker" id="ss_date_from" name="ss_date_from" type="text" data-date-format="yyyy-mm-dd" value="<?php echo date('Y-m-d'); ?>"/>
										...
										<div class="col-xs-12 col-sm-3">
											<div class="form-group">
												<label for="ss_date_to" class="control-label">Date To</label>
												<div class="input-group">
													<input class="form-control date-picker" id="ss_date_to" name="ss_date_to" type="text" data-date-format="yyyy-mm-dd" value="<?php echo date('Y-m-d'); ?>"/>
													<span class="input-group-addon">
														<i class="fa fa-calendar bigger-110"></i>
													</span>
												</div>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													if(isset($_POST['btn_search'])){
														...
														if($SESSION_GRANT=="ADMIN"){
															$ss_userid = "";
														}else{
															$ss_userid = $SESSION_ID;
														}
													}else{
														$is_continue = false;
													}
													//-----------------------------------------------------------------------------------------------//
													if($is_continue){
														$get_data = $this->M_library_database->DB_GET_DATA_SEARCH_LOG($ss_date_from,$ss_date_to,$ss_userid);
													...
													<tr>
														...
														<td><?php echo $data_row->LG_ID; ?></td>
														<td><?php echo $data_row->UR_ID; ?></td>
														<td><?php echo $data_row->LG_DESC; ?></td>
														<td><?php echo $data_row->LG_DATE; ?></td>
													</tr>
													<!-- Table Row -->
													<?php
															$index++;
							...
							<div class="row">
								<div class="col-xs-12">
									<form action="<?php echo site_url('C_log/data_download'); ?>" method="post" enctype="multipart/form-data">
