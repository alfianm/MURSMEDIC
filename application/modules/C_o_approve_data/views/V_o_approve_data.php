...
//-----------------------------------------------------------------------------------------------//
$is_continue_ekspedisi = true;
$get_data_ekspedisi = $this->M_library_database->DB_GET_DATA_ALL_EKSPEDISI();
if(empty($get_data_ekspedisi)||$get_data_ekspedisi==""){
	$is_continue_ekspedisi = false;
}
//-----------------------------------------------------------------------------------------------//
$is_continue_approve = true;
$get_data_approve = $this->M_library_database->DB_GET_DATA_ALL_PRODUCT_OUTBOUND_APPROVE();
...
<body class="no-skin">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<form action="<?php echo site_url('o_approve_data'); ?>" method="post" enctype="multipart/form-data">
												...
												<select class="chosen-select form-control" id="ss_doc_id" name="ss_doc_id" data-placeholder="Please Choose">
													...
													if($is_continue_approve){
														foreach($get_data_approve as $data_row_approve){
															$PTOD_ID = $data_row_approve->PTOD_ID;
													?>
													<option value="<?php echo $PTOD_ID; ?>"><?php echo $PTOD_ID; ?></option>
													<?php
														}
													}
													?>
							...
							<div class="row">
								<div class="col-xs-12">
									...
									<form action="<?php echo site_url('C_o_approve_data/data_approve'); ?>" method="post" enctype="multipart/form-data">
										<!------------------------------------------------------------------------------------------------->
										<?php
											$is_continue = true;
											
											$si_id = "";
											$si_date_send = date('Y-m-d');
											$si_distributor_id = "";
											$si_distributor_name = "";
											$si_distributor_phone = "";
											$si_distributor_email = "";
											$si_distributor_address = "";
											$si_distributor_address_shipping = "";
											$si_do_no = "";
											$si_order_no = "";
											$si_truck_type = "";
											$si_truck_no = "";
											...
											//-----------------------------------------------------------------------------------------------//
											if($is_continue){
												$get_data = $this->M_library_database->DB_GET_DATA_ALL_PRODUCT_OUTBOUND_SINGLE($ss_doc_id);
											...
											//-----------------------------------------------------------------------------------------------//
											if($is_continue){
												foreach($get_data as $data_row_all_product_outbound_single){
													$si_id = $data_row_all_product_outbound_single->PTOD_ID;
													$si_date_send = $data_row_all_product_outbound_single->PTOD_TGL_KIRIM;
													$si_distributor_id = $data_row_all_product_outbound_single->DR_ID;
													$si_distributor_name = $data_row_all_product_outbound_single->DR_NAME;
													$si_distributor_phone = $data_row_all_product_outbound_single->DR_PHONE;
													$si_distributor_email = $data_row_all_product_outbound_single->DR_EMAIL;
													$si_distributor_address = $data_row_all_product_outbound_single->DR_ADDRESS;
													$si_distributor_address_shipping = $data_row_all_product_outbound_single->DR_ADDRESS_SHIPPING;
													$si_do_no = $data_row_all_product_outbound_single->PTOD_DO_NO;
													$si_order_no = $data_row_all_product_outbound_single->PTOD_ORDER_NO;
													$si_truck_type = $data_row_all_product_outbound_single->PTOD_TRUCK_TYPE;
													$si_truck_no = $data_row_all_product_outbound_single->PTOD_TRUCK_NO;
													$si_driver = $data_row_all_product_outbound_single->PTOD_DRIVER;
													$si_ekspedisi_id = $data_row_all_product_outbound_single->EI_ID;
													$si_ekspedisi_name = $data_row_all_product_outbound_single->EI_NAME;
													$si_ekspedisi_phone = $data_row_all_product_outbound_single->EI_PHONE;
													$si_ekspedisi_email = $data_row_all_product_outbound_single->EI_EMAIL;
													$si_ekspedisi_address = $data_row_all_product_outbound_single->EI_ADDRESS;
													$si_seal_no = $data_row_all_product_outbound_single->PTOD_SEAL_NO;
												}
											}
										?>
										<!------------------------------------------------------------------------------------------------->
										...
										<div class="row">
											<div class="col-xs-12">
												<div class="col-xs-12 col-sm-3">
													<div class="form-group">
														<label for="si_date_send" class="control-label">Tgl Kirim</label>
														<div class="input-group">
															<input class="form-control date-picker" id="si_date_send" name="si_date_send" type="text" data-date-format="yyyy-mm-dd" value="<?php echo $si_date_send; ?>" required="required"/>
												...
												<div class="col-xs-12 col-sm-3">
													<div class="form-group">
														<label for="si_distributor_id" class="control-label">Distributor</label>
														<select class="chosen-select form-control" id="si_distributor_id" name="si_distributor_id" value="<?php echo $si_distributor_name; ?>" data-placeholder="Please Choose" required="required"/>
															<option value="<?php echo $si_distributor_id; ?>" selected><?php echo $si_distributor_name; ?></option>
															<?php
															if($is_continue_distributor){
																foreach($get_data_distributor as $data_row_distributor){
																	if($si_distributor_id!=$data_row_distributor->SR_ID){
																		$DR_ID = $data_row_distributor->DR_ID;
																		$DR_NAME = $data_row_distributor->DR_NAME;
																		
															?>
															<option value="<?php echo $DR_ID; ?>"><?php echo $DR_NAME; ?></option>
															<?php
																	}
																}
															}
												...
												<?php 
												if($is_continue){
													$dn_number_generator = $this->M_library_module->GENERATOR_DN_NUMBER();
												}else{
													$dn_number_generator = "";
												}
												?>
												<input type="hidden" id="si_do_no" name="si_do_no" class="form-control" value="<?php echo $dn_number_generator; ?>" maxlength="150" autocomplete="off" onkeyup="auto_caps(this)" required="required" readonly="readonly"/>
												<!-- Hidden DN Number -->
												
												<div class="col-xs-12 col-sm-3">
													<div class="form-group">
														<label for="si_order_no" class="control-label">Order No</label>
														<input type="text" id="si_order_no" name="si_order_no" class="form-control" value="<?php echo $si_order_no; ?>" maxlength="150" autocomplete="off" onkeyup="auto_caps(this)" required="required"/>
													</div>
												</div>
												<div class="col-xs-12 col-sm-3">
													<div class="form-group">
														<label for="si_truck_type" class="control-label">Truck Type</label>
														<input type="text" id="si_truck_type" name="si_truck_type" class="form-control" value="<?php echo $si_truck_type; ?>" maxlength="150" autocomplete="off" onkeyup="auto_caps(this)" required="required"/>
													</div>
												</div>
												<div class="col-xs-12 col-sm-3">
													<div class="form-group">
														<label for="si_truck_no" class="control-label">Truck No</label>
														<input type="text" id="si_truck_no" name="si_truck_no" class="form-control" value="<?php echo $si_truck_no; ?>" maxlength="150" autocomplete="off" onkeyup="auto_caps(this)" required="required"/>
													</div>
												</div>
												<div class="col-xs-12 col-sm-3">
													<div class="form-group">
														<label for="si_driver" class="control-label">Driver</label>
														<input type="text" id="si_driver" name="si_driver" class="form-control" value="<?php echo $si_driver; ?>" maxlength="150" autocomplete="off" onkeyup="auto_caps(this)" required="required"/>
													</div>
												</div>
												<div class="col-xs-12 col-sm-3">
													<div class="form-group">
														<label for="si_ekspedisi_id" class="control-label">Ekspedisi</label>
														<select class="chosen-select form-control" id="si_ekspedisi_id" name="si_ekspedisi_id" data-placeholder="Please Choose" required="required"/>
															<option value="<?php echo $si_ekspedisi_id; ?>" selected><?php echo $si_ekspedisi_name; ?></option>
															<?php
															if($is_continue_ekspedisi){
																foreach($get_data_ekspedisi as $data_row_ekspedisi){
																	if($si_ekspedisi_id!=$data_row_ekspedisi->EI_ID){
																		$EI_ID = $data_row_ekspedisi->EI_ID;
																		$EI_NAME = $data_row_ekspedisi->EI_NAME;
																		
															?>
															<option value="<?php echo $EI_ID; ?>"><?php echo $EI_NAME; ?></option>
															<?php
																	}
																}
															}
															...
															<div>
																<table id="tb_item" name="tb_item" class="table table-striped table-bordered">
																	...
																	<tbody>
																		...
																		<?php
																		if($is_continue){
																			$get_data_product_detail = $this->M_library_database->DB_GET_DATA_ALL_PRODUCT_OUTBOUND_DETAIL_BY_PRODUCT($si_id);
																		...
																		if($is_continue){
																			...
																			foreach($get_data_product_detail as $data_row_product_detail){
																				...
																				$si_product_detail_rack = $data_row_product_detail->RK_ID;
																				$si_product_detail_label = $data_row_product_detail->PTODDL_LABEL;
																				$si_product_detail_no = $data_row_product_detail->PTODDL_NO;
																		...
																		<tr id='addr<?php echo $index_row; ?>'>
																			...
																			<td>
																				<button class="tooltip-error btn_delete" data-toggle="modal" data-target="#modal-form-delete-detail" data-rel="tooltip" title="Delete"
																				data-sd_id_detail="<?php echo $data_row_product_detail->PT_ID; ?>"
	...
	<div id="modal-form-delete" class="modal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form-horizontal" action="<?php echo site_url('C_o_approve_data/data_delete'); ?>" method="post" enctype="multipart/form-data">
	...
	<div id="modal-form-delete-detail" class="modal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form-horizontal" action="<?php echo site_url('C_o_approve_data/data_delete_detail'); ?>" method="post" enctype="multipart/form-data">
					...
					<div class="modal-body">
						<div class="row">
							<div class="col-xs-12">
								<p>ARE YOU SURE, DELETE THIS DATA DETAIL ?</p>
								<div class="form-group">
									<label for="sd_id_detail" class="col-xs-12 col-sm-3 control-label" style="text-align:left">ID Detail</label>
									<div class="col-xs-12 col-sm-9">
										<input type="text" id="sd_id_detail" name="sd_id_detail" class="form-control sd_id_detail" required="required" readonly="readonly"/>
									</div>
								</div>
							</div>
						</div>
