...
<body class="no-skin">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<form action="<?php echo site_url('md_user'); ?>" method="post" enctype="multipart/form-data">
										...
										<div class="col-xs-12 col-sm-3">
											<div class="form-group">
												<label for="ss_grant_id" class="control-label">Grant ID</label>
												<select class="chosen-select form-control" id="ss_grant_id" name="ss_grant_id" data-placeholder="Please Choose">
													<option value="">Please Choose</option>
													<?php
													$is_continue_ext = true;
													$get_data_ext = $this->M_library_database->DB_GET_DATA_ALL_GRANT();
													...
													if($is_continue_ext){
														foreach($get_data_ext as $data_row_ext){
															$GT_ID = $data_row_ext->GT_ID;
													?>
													<option value="<?php echo $GT_ID; ?>"><?php echo $GT_ID; ?></option>
													<?php
														}
													}
													?>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													if(isset($_POST['btn_search'])){
														...
														$ss_grant_id = trim($this->input->post('ss_grant_id'));
													}else{
														$is_continue = false;
													}
													//-----------------------------------------------------------------------------------------------//
													if($is_continue){
														$get_data = $this->M_library_database->DB_GET_DATA_SEARCH_USER($ss_id,$ss_name,$ss_grant_id);
													...
													<tr>
														...
														<td><?php echo $data_row->UR_NAME; ?></td>
														<td><?php echo $data_row->UR_PHONE; ?></td>
														<td><?php echo $data_row->UR_EMAIL; ?></td>
														<td><?php echo $data_row->GT_ID; ?></td>
														
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<button class="blue btn_view" data-toggle="modal" data-target="#modal-form-view"
																data-sv_id="<?php echo $data_row->UR_ID; ?>"
																data-sv_name="<?php echo $data_row->UR_NAME; ?>"
																data-sv_phone="<?php echo $data_row->UR_PHONE; ?>"
																data-sv_email="<?php echo $data_row->UR_EMAIL; ?>"
																data-sv_grant_id="<?php echo $data_row->GT_ID; ?>"
																...
																data-su_id="<?php echo $data_row->UR_ID; ?>"
																data-su_password="<?php echo $data_row->UR_PASSWORD; ?>"
																data-su_name="<?php echo $data_row->UR_NAME; ?>"
																data-su_phone="<?php echo $data_row->UR_PHONE; ?>"
																data-su_email="<?php echo $data_row->UR_EMAIL; ?>"
																data-su_grant_id="<?php echo $data_row->GT_ID; ?>"
																...
																data-sd_id="<?php echo $data_row->UR_ID; ?>"
							...
							<div class="row">
								<div class="col-xs-12">
									<form action="<?php echo site_url('C_md_user/data_download'); ?>" method="post" enctype="multipart/form-data">
	...
	<div id="modal-form-new" class="modal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form-horizontal" action="<?php echo site_url('C_md_user/data_insert'); ?>" method="post" enctype="multipart/form-data">
					...
					<div class="modal-body">
						<div class="row">
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="si_password" class="col-xs-12 col-sm-3 control-label" style="text-align:left">Password</label>
									<div class="col-xs-12 col-sm-9">
										<input type="password" id="si_password" name="si_password" class="form-control" maxlength="150" autocomplete="off" onkeyup="auto_caps(this)" required="required"/>
									</div>
								</div>
							</div>
							...
							<div class="col-xs-12">
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-9">
										<input type="text" id="si_phone" name="si_phone" class="form-control" maxlength="15" autocomplete="off" onkeydown="numbers_only(event)" required="required"/>
									</div>
								</div>
							</div>
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="si_grant_id" class="col-xs-12 col-sm-3 control-label" style="text-align:left">Grant ID</label>
									<div class="col-xs-12 col-sm-9">
										<select class="chosen-select form-control" id="si_grant_id" name="si_grant_id" data-placeholder="Please Choose" required="required">
											<option value="">Please Choose</option>
											<?php
											$is_continue_ext = true;
											$get_data_ext = $this->M_library_database->DB_GET_DATA_ALL_GRANT();
				...
				<form class="form-horizontal">
					...
					<div class="modal-body">
						<div class="row">
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="sv_grant_id" class="col-xs-12 col-sm-3 control-label" style="text-align:left">Grant ID</label>
									<div class="col-xs-12 col-sm-9">
										<input type="text" id="sv_grant_id" name="sv_grant_id" class="form-control sv_grant_id" readonly="readonly"/>
									</div>
								</div>
							</div>
						</div>
	...
	<div id="modal-form-update" class="modal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form-horizontal" action="<?php echo site_url('C_md_user/data_update'); ?>" method="post" enctype="multipart/form-data">
					...
					<div class="modal-body">
						<div class="row">
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="su_password" class="col-xs-12 col-sm-3 control-label" style="text-align:left">Password</label>
									<div class="col-xs-12 col-sm-9">
										<input type="password" id="su_password" name="su_password" class="form-control su_password" maxlength="150" autocomplete="off" onkeyup="auto_caps(this)" required="required"/>
									</div>
								</div>
							</div>		
							...
							<div class="col-xs-12">
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-9">
										<input type="text" id="su_phone" name="su_phone" class="form-control su_phone" maxlength="15" autocomplete="off" onkeydown="numbers_only(event)" required="required"/>
									</div>
								</div>
							</div>
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="su_grant_id" class="col-xs-12 col-sm-3 control-label" style="text-align:left">Grant ID</label>
									<div class="col-xs-12 col-sm-9">
										<select class="chosen-select form-control su_grant_id" id="su_grant_id" name="su_grant_id" data-placeholder="Please Choose" required="required">
											<?php
											$is_continue_ext = true;
											$get_data_ext = $this->M_library_database->DB_GET_DATA_ALL_GRANT();
											if(empty($get_data_ext)||$get_data_ext==""){
	...
	<div id="modal-form-delete" class="modal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form-horizontal" action="<?php echo site_url('C_md_user/data_delete'); ?>" method="post" enctype="multipart/form-data">
	...
	<script type="text/javascript">
		...
		$(document).on( "click", '.btn_view',function(e) {
			...
			var sv_grant_id = $(this).data('sv_grant_id');
		
			$(".sv_id").val(sv_id);
			$(".sv_name").val(sv_name);
			$(".sv_phone").val(sv_phone);
			$(".sv_email").val(sv_email);
			$(".sv_grant_id").val(sv_grant_id);
		});
		//-----------------------------------------------------------------------------------------------//
		$(document).on( "click", '.btn_update',function(e) {
			var su_id = $(this).data('su_id');
			var su_password = $(this).data('su_password');
			var su_name = $(this).data('su_name');
			var su_phone = $(this).data('su_phone');
			var su_email = $(this).data('su_email');
			var su_grant_id = $(this).data('su_grant_id');
			
			$(".su_id").val(su_id);
			$(".su_password").val(su_password);
			$(".su_name").val(su_name);
			$(".su_phone").val(su_phone);
			$(".su_email").val(su_email);
			$(".su_grant_id").val(su_grant_id).trigger("chosen:updated");
		});
		//-----------------------------------------------------------------------------------------------//
