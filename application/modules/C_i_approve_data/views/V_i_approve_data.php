...
<head>
    ...
    <title>
        <?php echo $this->M_library_module->WEB_TITLE; ?>
    </title>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="col-xs-12 col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <option value="<?php echo $si_supplier_id; ?>" selected>
                                                            <?php echo $si_supplier_name; ?>
                                                        </option>
                                                        <?php
                                                ...
                                                <div class="col-xs-12 col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <option value="<?php echo $si_forwarder_id; ?>" selected>
                                                            <?php echo $si_forwarder_name; ?>
                                                        </option>
                                                        <?php
