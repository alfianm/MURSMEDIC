...
//-----------------------------------------------------------------------------------------------//
$is_continue_supplier = true;
$get_data_supplier = $this->M_library_database->DB_GET_DATA_ALL_SUPPLIER();
if (empty($get_data_supplier) || $get_data_supplier == "") {
	$is_continue_supplier = false;
}
//-----------------------------------------------------------------------------------------------//
$is_continue_forwarder = true;
$get_data_forwarder = $this->M_library_database->DB_GET_DATA_ALL_FORWARDER();
if (empty($get_data_forwarder) || $get_data_forwarder == "") {
	$is_continue_forwarder = false;
}
//-----------------------------------------------------------------------------------------------//
...
//-----------------------------------------------------------------------------------------------//
$is_continue_approve = true;
$get_data_approve = $this->M_library_database->DB_GET_DATA_ALL_PRODUCT_INBOUND_APPROVE();
if (empty($get_data_approve) || $get_data_approve == "") {
	$is_continue_approve = false;
}
//-----------------------------------------------------------------------------------------------//
?>
<!------------------------------------------------------------------------------------------------->
...
<body class="no-skin">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<form action="<?php echo site_url('i_approve_data'); ?>" method="post" enctype="multipart/form-data">
										<div class="col-xs-12 col-sm-3">
											<div class="form-group">
												<label for="ss_doc_id" class="control-label">Doc ID</label>
												<select class="chosen-select form-control" id="ss_doc_id" name="ss_doc_id" data-placeholder="Please Choose">
													<option value="">Please Choose</option>
													<?php
												if ($is_continue_approve) {
													foreach ($get_data_approve as $data_row_approve) {
														$PTID_ID = $data_row_approve->PTID_ID;
														?>
													<option value="<?php echo $PTID_ID; ?>"><?php echo $PTID_ID; ?></option>
													<?php
							...
							<?php 
						if (isset($_POST['ss_doc_id'])) {
							if ($_POST['ss_doc_id'] != "") {
								?>
							<div class="row">
								<div class="col-xs-12">
									<button id="btn_delete" name="btn_delete" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#modal-form-delete">
				...
				?>
							...
							<div class="row">
								<div class="col-xs-12">
									...
									<form action="<?php echo site_url('C_i_approve_data/data_approve'); ?>" method="post" enctype="multipart/form-data">
										<!------------------------------------------------------------------------------------------------->
										<?php
									$is_continue = true;

									$si_id = "";
									$si_date_receive = date('Y-m-d');
									$si_supplier_id = "";
									$si_supplier_name = "";
									$si_supplier_phone = "";
									$si_supplier_email = "";
									$si_supplier_address = "";
									$si_supplier_address_manufacturing = "";
									$si_po_no = "";
									$si_packing_list_no = "";
									$si_pib_no = "";
									$si_invoice_no = "";
									...
									$si_forwarder_phone = "";
									$si_forwarder_email = "";
									$si_forwarder_address = "";
									$si_container_no = "";
									$si_container_plat_no = "";
									$si_seal_no = "";
											//-----------------------------------------------------------------------------------------------//
									if (isset($_POST['btn_search'])) {
										$ss_doc_id = trim($this->input->post('ss_doc_id'));
									} else {
										$is_continue = false;
									}
											//-----------------------------------------------------------------------------------------------//
									if ($is_continue) {
										$get_data = $this->M_library_database->DB_GET_DATA_ALL_PRODUCT_INBOUND_SINGLE($ss_doc_id);
										if (empty($get_data) || $get_data == "") {
											...
											//-----------------------------------------------------------------------------------------------//
									if ($is_continue) {
										foreach ($get_data as $data_row_all_product_inbound_single) {
											$si_id = $data_row_all_product_inbound_single->PTID_ID;
											$si_date_receive = $data_row_all_product_inbound_single->PTID_TGL_TERIMA;
											$si_supplier_id = $data_row_all_product_inbound_single->SR_ID;
											$si_supplier_name = $data_row_all_product_inbound_single->SR_NAME;
											$si_supplier_phone = $data_row_all_product_inbound_single->SR_PHONE;
											$si_supplier_email = $data_row_all_product_inbound_single->SR_EMAIL;
											$si_supplier_address = $data_row_all_product_inbound_single->SR_ADDRESS;
											$si_supplier_address_manufacturing = $data_row_all_product_inbound_single->SR_ADDRESS_MANUFACTURING;
											$si_po_no = $data_row_all_product_inbound_single->PTID_PO_NO;
											$si_packing_list_no = $data_row_all_product_inbound_single->PTID_PACKING_LIST_NO;
											$si_pib_no = $data_row_all_product_inbound_single->PTID_PIB_NO;
											$si_invoice_no = $data_row_all_product_inbound_single->PTID_INVOICE_NO;
											$si_forwarder_id = $data_row_all_product_inbound_single->FR_ID;
											$si_forwarder_name = $data_row_all_product_inbound_single->FR_NAME;
											$si_forwarder_phone = $data_row_all_product_inbound_single->FR_PHONE;
											$si_forwarder_email = $data_row_all_product_inbound_single->FR_EMAIL;
											$si_forwarder_address = $data_row_all_product_inbound_single->FR_ADDRESS;
											$si_container_no = $data_row_all_product_inbound_single->PTID_CONTAINER_NO;
											$si_container_plat_no = $data_row_all_product_inbound_single->PTID_CONTAINER_PLAT_NO;
											$si_seal_no = $data_row_all_product_inbound_single->PTID_SEAL_NO;
										}
									}
									?>
										<!------------------------------------------------------------------------------------------------->
										<div class="row">
											<div class="col-xs-12">
												<div class="col-xs-12 col-sm-3">
													<div class="form-group">
														<label for="si_id" class="control-label">Doc ID</label>
														<input type="type" id="si_id" name="si_id" class="form-control" value="<?php echo $si_id; ?>" required="required" readonly="readonly"/>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-xs-12">
												<div class="col-xs-12 col-sm-3">
													<div class="form-group">
														<label for="si_date_receive" class="control-label">Tgl Terima</label>
														<div class="input-group">
															<input class="form-control date-picker" id="si_date_receive" name="si_date_receive" type="text" data-date-format="yyyy-mm-dd" value="<?php echo $si_date_receive; ?>" required="required"/>
												...
												<div class="col-xs-12 col-sm-3">
													<div class="form-group">
														<label for="si_supplier_id" class="control-label">Supplier</label>
														<select class="chosen-select form-control" id="si_supplier_id" name="si_supplier_id" value="<?php echo $si_supplier_name; ?>" data-placeholder="Please Choose" required="required"/>
															<option value="<?php echo $si_supplier_id; ?>" selected><?php echo $si_supplier_name; ?></option>
															<?php
														if ($is_continue_supplier) {
															foreach ($get_data_supplier as $data_row_supplier) {
																if ($si_supplier_id != $data_row_supplier->SR_ID) {
																	$SR_ID = $data_row_supplier->SR_ID;
																	$SR_NAME = $data_row_supplier->SR_NAME;

																	?>
															<option value="<?php echo $SR_ID; ?>"><?php echo $SR_NAME; ?></option>
															<?php
											...
											?>
												...
												<div class="col-xs-12 col-sm-3">
													<div class="form-group">
														<label for="si_po_no" class="control-label">PO No</label>
														<input type="text" id="si_po_no" name="si_po_no" class="form-control" value="<?php echo $si_po_no; ?>" maxlength="150" autocomplete="off" onkeyup="auto_caps(this)" required="required"/>
													</div>
												</div>
												<div class="col-xs-12 col-sm-3">
													<div class="form-group">
														<label for="si_packing_list_no" class="control-label">Packing List No</label>
														<input type="text" id="si_packing_list_no" name="si_packing_list_no" class="form-control" value="<?php echo $si_packing_list_no; ?>" maxlength="150" autocomplete="off" onkeyup="auto_caps(this)" required="required"/>
													</div>
												</div>
												<div class="col-xs-12 col-sm-3">
													<div class="form-group">
														<label for="si_pib_no" class="control-label">PIB No</label>
														<input type="text" id="si_pib_no" name="si_pib_no" class="form-control" value="<?php echo $si_pib_no; ?>" maxlength="150" autocomplete="off" onkeyup="auto_caps(this)" required="required"/>
													</div>
												</div>
												<div class="col-xs-12 col-sm-3">
													<div class="form-group">
														<label for="si_invoice_no" class="control-label">Invoice No</label>
														<input type="text" id="si_invoice_no" name="si_invoice_no" class="form-control" value="<?php echo $si_invoice_no; ?>" maxlength="150" autocomplete="off" onkeyup="auto_caps(this)" required="required"/>
													</div>
												</div>
												<div class="col-xs-12 col-sm-3">
													<div class="form-group">
														<label for="si_forwarder_id" class="control-label">Forwarder</label>
														<select class="chosen-select form-control" id="si_forwarder_id" name="si_forwarder_id" value="<?php echo $si_forwarder_name; ?>" data-placeholder="Please Choose" required="required"/>
															<option value="<?php echo $si_forwarder_id; ?>" selected><?php echo $si_forwarder_name; ?></option>
															<?php
														if ($is_continue_forwarder) {
															foreach ($get_data_forwarder as $data_row_forwarder) {
																if ($si_forwarder_id != $data_row_forwarder->FR_ID) {
																	$FR_ID = $data_row_forwarder->FR_ID;
																	$FR_NAME = $data_row_forwarder->FR_NAME;
																	?>
															<option value="<?php echo $FR_ID; ?>"><?php echo $FR_NAME; ?></option>
															<?php
											...
											?>
												...
												<div class="col-xs-12 col-sm-3">
													<div class="form-group">
														<label for="si_container_no" class="control-label">Container No</label>
														<input type="text" id="si_container_no" name="si_container_no" class="form-control" value="<?php echo $si_container_no; ?>" maxlength="150" autocomplete="off" onkeyup="auto_caps(this)" required="required"/>
													</div>
												</div>
												<div class="col-xs-12 col-sm-3">
													<div class="form-group">
														<label for="si_container_plat_no" class="control-label">Truck Plat No</label>
														<input type="text" id="si_container_plat_no" name="si_container_plat_no" class="form-control" value="<?php echo $si_container_plat_no; ?>" maxlength="150" autocomplete="off" onkeyup="auto_caps(this)" required="required"/>
													</div>
												</div>
												<div class="col-xs-12 col-sm-3">
													<div class="form-group">
														<label for="si_seal_no" class="control-label">Seal No</label>
														<input type="text" id="si_seal_no" name="si_seal_no" class="form-control" value="<?php echo $si_seal_no; ?>" maxlength="150" autocomplete="off" onkeyup="auto_caps(this)" required="required"/>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-xs-12">
												...
												<div class="row">
													<div class="col-xs-12">
														<div class="table-responsive">
															<div>
																<table id="tb_item" name="tb_item" class="table table-striped table-bordered">
																	...
																	<tbody>
																		...
																		<?php
																	if ($is_continue) {
																		$get_data_product_detail = $this->M_library_database->DB_GET_DATA_ALL_PRODUCT_INBOUND_DETAIL_BY_PRODUCT($si_id);
																		if (empty($get_data_product_detail) || $get_data_product_detail == "") {
																			$is_continue = false;
																		}
																	}
																	...
																	if ($is_continue) {
																		...
																		foreach ($get_data_product_detail as $data_row_product_detail) {
																			$si_detail_id = $data_row_product_detail->PTIDDL_ID;
																			...
																			$si_product_detail_no = $data_row_product_detail->PTIDDL_NO;
																			$si_product_detail_manufdate = $data_row_product_detail->PTIDDL_MANUFDATE;
																			$si_product_detail_expired = $data_row_product_detail->PTIDDL_EXPIRED;
																			$si_product_detail_qty = $data_row_product_detail->PTIDDL_QTY;
																			?>
																		<tr id='addr<?php echo $index_row; ?>'>
																			...
																			<td><input type="text" id="si_product_detail_id[]" name="si_product_detail_id[]" class="form-control" value="<?php echo $si_product_detail_id; ?>" required="required" readonly="readonly"/></td>
																			<td><input type="text" id="si_product_detail_name[]" name="si_product_detail_name[]" class="form-control" value="<?php echo $si_product_detail_name; ?>" required="required" readonly="readonly"/></td>
																			<td><input type="text" class="form-control" value="<?php echo $si_product_detail_unit; ?>" required="required" readonly="readonly"/></td>
																			<td><input type="text" id="si_product_no[]" name="si_product_no[]" class="form-control" value="<?php echo $si_product_detail_no; ?>" maxlength="150" autocomplete="off" onkeyup="auto_caps(this)"/></td>
																			<td><input type="text" class="form-control" value="<?php echo $si_product_detail_manufdate; ?>" required="required" readonly="readonly"/></td>
																			<td><input type="text" id="si_product_qty_total[]" name="si_product_qty_total[]" class="form-control si_product_qty_total" value="<?php echo $si_product_detail_qty; ?>" required="required" readonly="readonly"/></td>
																			<td><input type="text" id="si_product_qty_good[]" name="si_product_qty_good[]" class="form-control si_product_qty_good" value="<?php echo $si_product_detail_qty; ?>" maxlength="20" autocomplete="off" onkeyup="hitung();" required="required"/></td>
																			<td><input type="text" id="si_product_qty_bad[]" name="si_product_qty_bad[]" class="form-control si_product_qty_bad" value="0" maxlength="20" autocomplete="off" onkeyup="hitung();" required="required"/></td>
																			<td><input type="text" class="form-control" value="<?php echo $si_product_detail_expired; ?>" readonly="readonly"/></td>
																		</tr>
																		<?php
																	$index_row++;
																	$index++;
															...
															?>
																		<!------------------------------------------------------------------------------------------------->
																		<tr id='addr<?php echo $index_row; ?>'></tr>
												...
												<p>
													<?php if ($is_continue) { ?>
													<button id="btn_approve" name="btn_approve" class="btn btn-success btn-xs">
	...
	<div id="modal-form-delete" class="modal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form-horizontal" action="<?php echo site_url('C_i_approve_data/data_delete'); ?>" method="post" enctype="multipart/form-data">
							...
							<div class="col-xs-12">
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-9">
										<input type="text" id="sd_id" name="sd_id" class="form-control" value="<?php echo $si_id; ?>" required="required" readonly="readonly"/>
									</div>
								</div>
							</div>
						</div>
	...
	$(document).ready(function() {
  		$("[id='si_product_qty_good[]']").keyup(function(){
    		var bayar = parseInt($(this).closest('tr').find("[id='si_product_qty_total[]']").val())|0;
    		var kuantiti = parseInt($(this).closest('tr').find("[id='si_product_qty_good[]']").val())|0;
    		var total_bayar= bayar - kuantiti;
    	$(this).closest('tr').find("[id='si_product_qty_bad[]']").val(total_bayar)
  		});
	});
		//-----------------------------------------------------------------------------------------------//
		function web_reload() {
