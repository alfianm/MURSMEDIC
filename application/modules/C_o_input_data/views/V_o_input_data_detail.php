...
$get_data_distributor = $this->M_library_database->DB_GET_DATA_SEARCH_DISTRIBUTOR($si_distributor_id,"");
foreach($get_data_distributor as $data_row_distributor){
	$si_distributor_name = $data_row_distributor->DR_NAME;
	$si_distributor_phone = $data_row_distributor->DR_PHONE;
	$si_distributor_email = $data_row_distributor->DR_EMAIL;
	$si_distributor_address = $data_row_distributor->DR_ADDRESS;
	$si_distributor_address_shipping = $data_row_distributor->DR_ADDRESS_SHIPPING;
}

$si_order_no = trim($this->input->post('si_order_no'));

$si_ekspedisi_id = trim($this->input->post('si_ekspedisi_id'));
$get_data_ekspedisi = $this->M_library_database->DB_GET_DATA_SEARCH_EKSPEDISI($si_ekspedisi_id,"");
foreach($get_data_ekspedisi as $data_row_ekspedisi){
	$si_ekspedisi_name = $data_row_ekspedisi->EI_NAME;
	$si_ekspedisi_phone = $data_row_ekspedisi->EI_PHONE;
	$si_ekspedisi_email = $data_row_ekspedisi->EI_EMAIL;
	$si_ekspedisi_address = $data_row_ekspedisi->EI_ADDRESS;
}
//-----------------------------------------------------------------------------------------------//
?>
<!------------------------------------------------------------------------------------------------->
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									...
									<div class="col-xs-6 center">
										<h4>Picking Slip Form Detail</h4>
									</div>
								</div>
							</div>
							...
							<form action="<?php echo site_url('C_o_input_data/data_insert_detail'); ?>" method="post" enctype="multipart/form-data">
								<!------------------------------------------------------------------------------------------------->					
								<div class="row">
									<div class="col-xs-12">
										<div class="col-xs-12 col-sm-4">
											<p>
												<input type="hidden" id="si_id" name="si_id" class="form-control" value="<?php echo $si_id; ?>" required="required" readonly="readonly"/>
												Doc ID : <?php echo $si_id; ?>
												<br />
												Userid : <?php echo $SESSION_ID; ?>
												<br />											
											</p>
										</div>
										<div class="col-xs-12 col-sm-4">
											Tgl Kirim : <?php echo $si_date_send; ?>
											<br />
											Distributor : <?php echo "(".$si_distributor_id.")"." ".$si_distributor_name; ?>
											<br />
											Order No : <?php echo $si_order_no; ?>
											<br />
											Ekspedisi : <?php echo "(".$si_ekspedisi_id.")"." ".$si_ekspedisi_name; ?>
										</div>
									</div>
								</div>
														...
														<table id="tb_item" name="tb_item" class="table table-striped table-bordered">
															...
															<tbody>
																...
																for($x = 0; $x < $array_si_product_id_length; $x++) {
																	...
																	$PRODUCT_ID = $array_product[0];//ID PRODUCT A
																	
																	$STOCK = $array_si_product_stock[$x];
																	$QTY = $array_si_product_qty[$x];
																
																	$get_data_stock = $this->M_library_database->DB_GET_DATA_ALL_PRODUCT_STOCK_SINGLE($PRODUCT_ID);
																	foreach($get_data_stock as $data_row_stock){
																		$PT_ID = $data_row_stock->PT_ID;
																		$PT_NAME = $data_row_stock->PT_NAME;
																		$RK_ID = $data_row_stock->RK_ID;
																		$PTIDDL_LABEL = $data_row_stock->PTIDDL_LABEL;
																		$PTIDDL_NO = $data_row_stock->PTIDDL_NO;
																		$PTIDDL_MANUFDATE = $data_row_stock->PTIDDL_MANUFDATE;
																		$PTIDDL_QTY_GOOD = $data_row_stock->PTIDDL_QTY_GOOD;
																		$PTIDDL_EXPIRED = $data_row_stock->PTIDDL_EXPIRED;
																		
																		if(($PTIDDL_QTY_GOOD - $QTY) < 0){
																			$QTY = $QTY - $PTIDDL_QTY_GOOD;
																?>
																<tr>
																	...
																	<td><input type="text" id="si_product_detail_name[]" name="si_product_detail_name[]" class="form-control" value="<?php echo $PT_NAME; ?>" required="required" readonly="readonly"/></td>
																	<td><input type="text" id="si_product_detail_rack[]" name="si_product_detail_rack[]" class="form-control" value="<?php echo $RK_ID; ?>" required="required" readonly="readonly"/></td>
																	<input type="text" id="si_product_detail_label[]" name="si_product_detail_label[]" class="form-control hidden" value="<?php echo $PTIDDL_LABEL; ?>" required="required" readonly="readonly"/>
																	<td><input type="text" id="si_product_detail_no[]" name="si_product_detail_no[]" class="form-control" value="<?php echo $PTIDDL_NO; ?>" required="required" readonly="readonly"/></td>
																	<td><input type="text" id="si_product_detail_manufdate[]" name="si_product_detail_manufdate[]" class="form-control" value="<?php echo $PTIDDL_MANUFDATE; ?>" required="required" readonly="readonly"/></td>
																	<td><input type="text" id="si_product_detail_qty[]" name="si_product_detail_qty[]" class="form-control" value="<?php echo $PTIDDL_QTY_GOOD; ?>" required="required" readonly="readonly"/></td>
																	<td><input type="text" id="si_product_detail_expired[]" name="si_product_detail_expired[]" class="form-control" value="<?php echo $PTIDDL_EXPIRED; ?>" required="required" readonly="readonly"/></td>
																</tr>
																<?php
																			$index++;
																		}else{
