...
//-----------------------------------------------------------------------------------------------//
$is_continue_product_stock = true;
$get_data_product_stock = $this->M_library_database->DB_GET_DATA_ALL_PRODUCT_STOCK();
if(empty($get_data_product_stock)||$get_data_product_stock==""){
	$is_continue_product_stock = false;
}
$array_data_real_stock = array();
foreach($get_data_product_stock as $data_row_product_stock){
	$PT_ID = $data_row_product_stock->PT_ID;
	$get_data_real_stock = $this->M_library_database->DB_GET_DATA_SEARCH_DETAIL_PRODUCT_STOCK($PT_ID);
	foreach($get_data_real_stock as $data_row_real_stock){
		$STOCK = $data_row_real_stock->STOCK;
		$array_data_real_stock[] = $STOCK;
	}
}
//var_dump(json_encode($array_data_real_stock));die();
//-----------------------------------------------------------------------------------------------//
?>
<!------------------------------------------------------------------------------------------------->
<!DOCTYPE html>
...
<body class="no-skin">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form action="<?php echo site_url('C_o_input_data/data_insert'); ?>" method="post" enctype="multipart/form-data">
								<!------------------------------------------------------------------------------------------------->					
								<div class="row">
									<div class="col-xs-12">
										<div class="col-xs-12 col-sm-3">
											<div class="form-group">
												...
												<input type="type" id="si_id" name="si_id" class="form-control" value="<?php echo $this->M_library_module->GENERATOR_DOCID_OUTBOUND(); ?>" required="required" readonly="readonly"/>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="col-xs-12">
										<div class="col-xs-12 col-sm-3">
											<div class="form-group">
												...
												<div class="input-group">
													<input class="form-control date-picker" id="si_date_send" name="si_date_send" type="text" data-date-format="yyyy-mm-dd" value="<?php echo date('Y-m-d'); ?>" required="required"/>
										...
										<div class="col-xs-12 col-sm-3">
											<div class="form-group">
												...
												<select class="chosen-select form-control" id="si_distributor_id" name="si_distributor_id" data-placeholder="Please Choose" required="required"/>
										...
										<div class="col-xs-12 col-sm-3">
											<div class="form-group">
												...
												<input type="text" id="si_order_no" name="si_order_no" class="form-control" maxlength="150" autocomplete="off" onkeyup="auto_caps(this)" required="required"/>
											</div>
										</div>
										<div class="col-xs-12 col-sm-3">
											<div class="form-group">
														...
														<table id="tb_item" name="tb_item" class="table table-striped table-bordered">
															...
															<tbody>
																...
																<tr id='addr0'>
																	...
																	<td><input type="text" id="si_product_stock[]" name="si_product_stock[]" class="form-control si_product_stock" required="required" readonly="readonly"/></td>
	...
	<script type="text/javascript">
		...
		function select_value_product(id){
			el='#'+id;
			var myArray = JSON.parse('<?php echo json_encode($get_data_product_stock); ?>');
			var myArrayStock = JSON.parse('<?php echo json_encode($array_data_real_stock); ?>');
			...
			for(var i = 0; i<myArray.length;i++){
				...
				var PT_STOCK = myArrayStock[i];
				
				var BUILD_DATA = PT_ID+"[]"+PT_NAME+"[]"+PT_UNIT+"[]"+PT_UNIT_MAX+"[]"+PT_TYPE+"[]"+PT_IS_MANUFDATE+"[]"+PT_STOCK;
		...
		$(document).ready(function(){
			...
			$("#btn_new_row").click(function(){
				...
				$('#tb_item').append('<tr id="addr'+(i+1)+'"></tr>');
		...
		function product_info(pointer){
			...
			$(pointer).closest("tr").find(".si_product_stock").val(array[6]);
		}
		//dynamic table
		//-----------------------------------------------------------------------------------------------//
		jQuery(function($) {
