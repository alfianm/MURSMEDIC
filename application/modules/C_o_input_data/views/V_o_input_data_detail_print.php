...
//-----------------------------------------------------------------------------------------------//
$get_data_all_product_outbound_single = $this->M_library_database->DB_GET_DATA_ALL_PRODUCT_OUTBOUND_SINGLE($si_id);
if(empty($get_data_all_product_outbound_single)||$get_data_all_product_outbound_single==""){
	echo '
		<script>
...
//-----------------------------------------------------------------------------------------------//
foreach($get_data_all_product_outbound_single as $data_row_all_product_outbound_single){
		...
		<div class="main-content">
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<a href="<?php echo site_url('o_input_data'); ?>" class="btn btn-success btn-xs"><i class="ace-icon fa fa-home"></i></a>
							&nbsp;
														...
														<table id="tb_item" name="tb_item" class="table table-striped table-bordered">
															...
															<tbody>
																...
																for($x = 0; $x < $array_si_product_detail_no_length; $x++) {
																	...
																	$si_product_detail_rack = $array_si_product_detail_rack[$x];
																	$si_product_detail_label = $array_si_product_detail_label[$x];
																...
																<?php
																	...
																	$get_data_all_product_single_info = $this->M_library_database->DB_GET_DATA_ALL_PRODUCT_SINGLE($si_product_detail_id);
																	foreach($get_data_all_product_single_info as $data_row_data_all_product_single_info){
																		$PT_WEIGHT = $data_row_data_all_product_single_info->PT_WEIGHT;
																		$PT_VOLUME = $data_row_data_all_product_single_info->PT_VOLUME;
