...
<body class="no-skin">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<form action="<?php echo site_url('md_distributor'); ?>" method="post" enctype="multipart/form-data">
										...
										<div class="col-xs-12 col-sm-3">
											<div class="form-group">
												<label for="ss_city" class="control-label">City</label>
												<input type="text" id="ss_city" name="ss_city" class="form-control" maxlength="150" autocomplete="off" onkeyup="auto_caps(this)"/>
											</div>
										</div>
										<div class="col-xs-12">
											<div class="form-group">
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													if(isset($_POST['btn_search'])){
														...
														$ss_city = trim($this->input->post('ss_city'));
													}else{
														$is_continue = false;
													}
													//-----------------------------------------------------------------------------------------------//
													if($is_continue){
														$get_data = $this->M_library_database->DB_GET_DATA_SEARCH_DISTRIBUTOR_EXT($ss_id,$ss_name,$ss_city);
													...
													<tr>
														...
														<td><?php echo $data_row->DR_ID; ?></td>
														<td><?php echo $data_row->DR_NAME; ?></td>
														<td><?php echo $data_row->DR_PHONE; ?></td>
														<td><?php echo $data_row->DR_EMAIL; ?></td>
														<td><?php echo $data_row->DR_ADDRESS; ?></td>
														<td><?php echo $data_row->DR_ADDRESS_SHIPPING; ?></td>
														<td><?php echo $data_row->DR_CITY; ?></td>
														
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<button class="blue btn_view" data-toggle="modal" data-target="#modal-form-view"
																data-sv_id="<?php echo $data_row->DR_ID; ?>"
																data-sv_name="<?php echo $data_row->DR_NAME; ?>"
																data-sv_phone="<?php echo $data_row->DR_PHONE; ?>"
																data-sv_email="<?php echo $data_row->DR_EMAIL; ?>"
																data-sv_address="<?php echo $data_row->DR_ADDRESS; ?>"
																data-sv_address_shipping="<?php echo $data_row->DR_ADDRESS_SHIPPING; ?>"
																data-sv_city="<?php echo $data_row->DR_CITY; ?>"
																...
																data-su_id="<?php echo $data_row->DR_ID; ?>"
																data-su_name="<?php echo $data_row->DR_NAME; ?>"
																data-su_phone="<?php echo $data_row->DR_PHONE; ?>"
																data-su_email="<?php echo $data_row->DR_EMAIL; ?>"
																data-su_address="<?php echo $data_row->DR_ADDRESS; ?>"
																data-su_address_shipping="<?php echo $data_row->DR_ADDRESS_SHIPPING; ?>"
																data-su_city="<?php echo $data_row->DR_CITY; ?>"
																...
																data-sd_id="<?php echo $data_row->DR_ID; ?>"
							...
							<div class="row">
								<div class="col-xs-12">
									<form action="<?php echo site_url('C_md_distributor/data_download'); ?>" method="post" enctype="multipart/form-data">
	...
	<div id="modal-form-new" class="modal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form-horizontal" action="<?php echo site_url('C_md_distributor/data_insert'); ?>" method="post" enctype="multipart/form-data">
					...
					<div class="modal-body">
						<div class="row">
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="si_address_shipping" class="col-xs-12 col-sm-3 control-label" style="text-align:left">Shipping Address</label>
									<div class="col-xs-12 col-sm-9">
										<textarea name="si_address_shipping" id="si_address_shipping" rows="3" class="form-control" autocomplete="off" style="overflow:auto;resize:none" required="required"></textarea>
									</div>
								</div>
							</div>
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="si_city" class="col-xs-12 col-sm-3 control-label" style="text-align:left">City</label>
									<div class="col-xs-12 col-sm-9">
										<input type="text" id="si_city" name="si_city" class="form-control" maxlength="150" autocomplete="off" onkeyup="auto_caps(this)" required="required"/>
									</div>
								</div>
							</div>
						</div>
				...
				<form class="form-horizontal">
					...
					<div class="modal-body">
						<div class="row">
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="sv_address_shipping" class="col-xs-12 col-sm-3 control-label" style="text-align:left">Shipping Address</label>
									<div class="col-xs-12 col-sm-9">
										<textarea name="sv_address_shipping" id="sv_address_shipping" rows="3" class="form-control sv_address_shipping" style="overflow:auto;resize:none" readonly="readonly"></textarea>
									</div>
								</div>
							</div>
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="sv_city" class="col-xs-12 col-sm-3 control-label" style="text-align:left">City</label>
									<div class="col-xs-12 col-sm-9">
										<input type="text" id="sv_city" name="sv_city" class="form-control sv_city" readonly="readonly"/>
									</div>
								</div>
							</div>
						</div>
	...
	<div id="modal-form-update" class="modal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form-horizontal" action="<?php echo site_url('C_md_distributor/data_update'); ?>" method="post" enctype="multipart/form-data">
					...
					<div class="modal-body">
						<div class="row">
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="su_address_shipping" class="col-xs-12 col-sm-3 control-label" style="text-align:left">Shipping Address</label>
									<div class="col-xs-12 col-sm-9">
										<textarea name="su_address_shipping" id="su_address_shipping" rows="3" class="form-control su_address_shipping" autocomplete="off" style="overflow:auto;resize:none" required="required"></textarea>
									</div>
								</div>
							</div>
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="su_city" class="col-xs-12 col-sm-3 control-label" style="text-align:left">CIty</label>
									<div class="col-xs-12 col-sm-9">
										<input type="text" id="su_city" name="su_city" class="form-control su_city" maxlength="150" autocomplete="off" onkeyup="auto_caps(this)" required="required"/>
									</div>
								</div>
							</div>
						</div>
	...
	<div id="modal-form-delete" class="modal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form-horizontal" action="<?php echo site_url('C_md_distributor/data_delete'); ?>" method="post" enctype="multipart/form-data">
	...
	<script type="text/javascript">
		...
		$(document).on( "click", '.btn_view',function(e) {
			...
			var sv_address_shipping = $(this).data('sv_address_shipping');
			var sv_city = $(this).data('sv_city');
			...
			$(".sv_address_shipping").val(sv_address_shipping);
			$(".sv_city").val(sv_city);
		});
		//-----------------------------------------------------------------------------------------------//
		$(document).on( "click", '.btn_update',function(e) {
			...
			var su_address_shipping = $(this).data('su_address_shipping');
			var su_city = $(this).data('su_city');
			...
			$(".su_address_shipping").val(su_address_shipping);
			$(".su_city").val(su_city);
		});
		//-----------------------------------------------------------------------------------------------//
