...
<body class="no-skin">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<form action="<?php echo site_url('md_rack'); ?>" method="post" enctype="multipart/form-data">
										...
										<div class="col-xs-12 col-sm-3">
											<div class="form-group">
												<label for="ss_type" class="control-label">Type / Name</label>
												<select class="chosen-select form-control" id="ss_type" name="ss_type" data-placeholder="Please Choose">
										...
										<div class="col-xs-12 col-sm-3">
											<div class="form-group">
												<label for="ss_storage_id" class="control-label">Storage ID</label>
												<select class="chosen-select form-control" id="ss_storage_id" name="ss_storage_id" data-placeholder="Please Choose">
													<option value="">Please Choose</option>
													<?php
												$is_continue_ext = true;
												$get_data_ext = $this->M_library_database->DB_GET_DATA_ALL_STORAGE();
												...
												if ($is_continue_ext) {
													foreach ($get_data_ext as $data_row_ext) {
														$SE_ID = $data_row_ext->SE_ID;
														?>
													<option value="<?php echo $SE_ID; ?>"><?php echo $SE_ID; ?></option>
													<?php
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												if (isset($_POST['btn_search'])) {
													...
													$ss_type = trim($this->input->post('ss_type'));
													$ss_storage_id = trim($this->input->post('ss_storage_id'));
												} else {
													$is_continue = false;
												}
													//-----------------------------------------------------------------------------------------------//
												if ($is_continue) {
													$get_data = $this->M_library_database->DB_GET_DATA_SEARCH_RACK($ss_id, $ss_type, $ss_storage_id);
												...
												if ($is_continue) {
													...
													<tr>
														...
														<td><?php echo $data_row->RK_ID; ?></td>
														<td><?php echo $data_row->RK_TYPE; ?></td>
														<td><?php echo $data_row->RK_SUBRACK; ?></td>
														<td><?php echo $data_row->RK_LEVEL; ?></td>
														<td><?php echo $data_row->SE_ID; ?></td>
														
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<button class="blue btn_view" data-toggle="modal" data-target="#modal-form-view"
																data-sv_id="<?php echo $data_row->RK_ID; ?>"
																data-sv_type="<?php echo $data_row->RK_TYPE; ?>"
																data-sv_subrack="<?php echo $data_row->RK_SUBRACK; ?>"
																data-sv_level="<?php echo $data_row->RK_LEVEL; ?>"
																data-sv_storage_id="<?php echo $data_row->SE_ID; ?>"
																...
																data-su_id="<?php echo $data_row->RK_ID; ?>"
																data-su_type="<?php echo $data_row->RK_TYPE; ?>"
																data-su_subrack="<?php echo $data_row->RK_SUBRACK; ?>"
																data-su_level="<?php echo $data_row->RK_LEVEL; ?>"
																data-su_storage_id="<?php echo $data_row->SE_ID; ?>"
																...
																data-sd_id="<?php echo $data_row->RK_ID; ?>"
							...
							<div class="row">
								<div class="col-xs-12">
									<form action="<?php echo site_url('C_md_rack/data_download'); ?>" method="post" enctype="multipart/form-data">
	...
	<div id="modal-form-new" class="modal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form-horizontal" action="<?php echo site_url('C_md_rack/data_insert'); ?>" method="post" enctype="multipart/form-data">
					...
					<div class="modal-body">
						<div class="row">
							<div class="col-xs-12">
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-9">
										<input type="text" id="si_id" name="si_id" class="form-control" maxlength="3" autocomplete="off" onkeyup="auto_caps(this)" required="required"/>
									</div>
								</div>
							</div>
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="si_type" class="col-xs-12 col-sm-3 control-label" style="text-align:left">Type / Name</label>
									<div class="col-xs-12 col-sm-9">
										<select class="chosen-select form-control" id="si_type" name="si_type" data-placeholder="Please Choose" required="required" onChange="insert_autosubrack(this);">
											<option value="">Please Choose</option>
											<option value="SINGLE">SINGLE</option>
											<option value="DRIVE IN">DRIVE IN</option>
										</select>
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="si_subrack" class="col-xs-12 col-sm-3 control-label" style="text-align:left">Subrack</label>
									<div class="col-xs-12 col-sm-9">
										<input type="text" id="si_subrack" name="si_subrack" class="form-control" maxlength="20" autocomplete="off" onkeydown="numbers_only(event)" required="required"/>
									</div>
								</div>
							</div>
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="si_level" class="col-xs-12 col-sm-3 control-label" style="text-align:left">Level</label>
									<div class="col-xs-12 col-sm-9">
										<input type="text" id="si_level" name="si_level" class="form-control" value="1" maxlength="20" autocomplete="off" onkeydown="numbers_only(event)" required="required"/>
									</div>
								</div>
							</div>
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="si_storage_id" class="col-xs-12 col-sm-3 control-label" style="text-align:left">Storage ID</label>
									<div class="col-xs-12 col-sm-9">
										<select class="chosen-select form-control" id="si_storage_id" name="si_storage_id" data-placeholder="Please Choose" required="required">
											<option value="">Please Choose</option>
											<?php
										$is_continue_ext = true;
										$get_data_ext = $this->M_library_database->DB_GET_DATA_ALL_STORAGE();
				...
				<form class="form-horizontal">
					...
					<div class="modal-body">
						<div class="row">
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="sv_type" class="col-xs-12 col-sm-3 control-label" style="text-align:left">Type / Name</label>
									<div class="col-xs-12 col-sm-9">
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="sv_subrack" class="col-xs-12 col-sm-3 control-label" style="text-align:left">Subrack</label>
									<div class="col-xs-12 col-sm-9">
										<input type="text" id="sv_subrack" name="sv_subrack" class="form-control sv_subrack" readonly="readonly"/>
									</div>
								</div>
							</div>
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="sv_level" class="col-xs-12 col-sm-3 control-label" style="text-align:left">Level</label>
									<div class="col-xs-12 col-sm-9">
										<input type="text" id="sv_level" name="sv_level" class="form-control sv_level" readonly="readonly"/>
									</div>
								</div>
							</div>
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="sv_storage_id" class="col-xs-12 col-sm-3 control-label" style="text-align:left">Storage ID</label>
									<div class="col-xs-12 col-sm-9">
										<input type="text" id="sv_storage_id" name="sv_storage_id" class="form-control sv_storage_id" readonly="readonly"/>
									</div>
								</div>
							</div>
						</div>
	...
	<div id="modal-form-update" class="modal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form-horizontal" action="<?php echo site_url('C_md_rack/data_update'); ?>" method="post" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-xs-12">
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-9">
										<input type="text" id="su_id" name="su_id" class="form-control su_id" maxlength="3" autocomplete="off" onkeyup="auto_caps(this)" required="required"/>
									</div>
								</div>
							</div>
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="su_type" class="col-xs-12 col-sm-3 control-label" style="text-align:left">Type / Name</label>
									<div class="col-xs-12 col-sm-9">
										<select class="chosen-select form-control su_type" id="su_type" name="su_type" data-placeholder="Please Choose" required="required" onChange="update_autosubrack(this);">
											<option value="SINGLE">SINGLE</option>
											<option value="DRIVE IN">DRIVE IN</option>
										</select>
									</div>
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="su_subrack" class="col-xs-12 col-sm-3 control-label" style="text-align:left">Subrack</label>
									<div class="col-xs-12 col-sm-9">
										<input type="text" id="su_subrack" name="su_subrack" class="form-control su_subrack" maxlength="20" autocomplete="off" onkeydown="numbers_only(event)" required="required"/>
									</div>
								</div>
							</div>
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="su_level" class="col-xs-12 col-sm-3 control-label" style="text-align:left">Level</label>
									<div class="col-xs-12 col-sm-9">
										<input type="text" id="su_level" name="su_level" class="form-control su_level" maxlength="20" autocomplete="off" onkeydown="numbers_only(event)" required="required"/>
									</div>
								</div>
							</div>
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="su_storage_id" class="col-xs-12 col-sm-3 control-label" style="text-align:left">Storage ID</label>
									<div class="col-xs-12 col-sm-9">
										<select class="chosen-select form-control su_storage_id" id="su_storage_id" name="su_storage_id" data-placeholder="Please Choose" required="required">
											<?php
										$is_continue_ext = true;
										$get_data_ext = $this->M_library_database->DB_GET_DATA_ALL_STORAGE();
										if (empty($get_data_ext) || $get_data_ext == "") {
	...
	<div id="modal-form-delete" class="modal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form-horizontal" action="<?php echo site_url('C_md_rack/data_delete'); ?>" method="post" enctype="multipart/form-data">
	...
	<script type="text/javascript">
		...
		//-----------------------------------------------------------------------------------------------//
		function insert_autosubrack(pointer){
			var selection = $(pointer).val();
			if(selection=="SINGLE"){
				document.getElementById("si_subrack").value = "1";
				document.getElementById("si_subrack").readOnly = true;
			}else{
				document.getElementById("si_subrack").value = "";
				document.getElementById("si_subrack").readOnly = false;
			}
		}
		//-----------------------------------------------------------------------------------------------//
		function update_autosubrack(pointer){
			var selection = $(pointer).val();
			if(selection=="SINGLE"){
				document.getElementById("su_subrack").value = "1";
				document.getElementById("su_subrack").readOnly = true;
			}else{
				document.getElementById("su_subrack").value = "";
				document.getElementById("su_subrack").readOnly = false;
			}
		}
		//-----------------------------------------------------------------------------------------------//
		$(document).on( "click", '.btn_view',function(e) {
			...
			var sv_subrack = $(this).data('sv_subrack');
			var sv_level = $(this).data('sv_level');
			var sv_storage_id = $(this).data('sv_storage_id');
		
			$(".sv_id").val(sv_id);
			$(".sv_type").val(sv_type);
			$(".sv_subrack").val(sv_subrack);
			$(".sv_level").val(sv_level);
			$(".sv_storage_id").val(sv_storage_id);
		});
		//-----------------------------------------------------------------------------------------------//
		$(document).on( "click", '.btn_update',function(e) {
			var su_id = $(this).data('su_id');
			var su_type = $(this).data('su_type');
			var su_subrack = $(this).data('su_subrack');
			var su_level = $(this).data('su_level');
			var su_storage_id = $(this).data('su_storage_id');
			
			$(".su_id_lastest").val(su_id);
			$(".su_id").val(su_id);
			$(".su_type").val(su_type).trigger("chosen:updated");
			$(".su_subrack").val(su_subrack);
			$(".su_level").val(su_level);
			$(".su_storage_id").val(su_storage_id).trigger("chosen:updated");
		});
		//-----------------------------------------------------------------------------------------------//
