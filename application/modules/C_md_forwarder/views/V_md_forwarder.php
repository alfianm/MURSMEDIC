...
<body class="no-skin">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<form action="<?php echo site_url('md_forwarder'); ?>" method="post" enctype="multipart/form-data">
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													//-----------------------------------------------------------------------------------------------//
													if($is_continue){
														$get_data = $this->M_library_database->DB_GET_DATA_SEARCH_FORWARDER($ss_id,$ss_name);
													...
													<tr>
														...
														<td><?php echo $data_row->FR_ID; ?></td>
														<td><?php echo $data_row->FR_NAME; ?></td>
														<td><?php echo $data_row->FR_PHONE; ?></td>
														<td><?php echo $data_row->FR_EMAIL; ?></td>
														<td><?php echo $data_row->FR_ADDRESS; ?></td>
														
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<button class="blue btn_view" data-toggle="modal" data-target="#modal-form-view"
																data-sv_id="<?php echo $data_row->FR_ID; ?>"
																data-sv_name="<?php echo $data_row->FR_NAME; ?>"
																data-sv_phone="<?php echo $data_row->FR_PHONE; ?>"
																data-sv_email="<?php echo $data_row->FR_EMAIL; ?>"
																data-sv_address="<?php echo $data_row->FR_ADDRESS; ?>"
																...
																data-su_id="<?php echo $data_row->FR_ID; ?>"
																data-su_name="<?php echo $data_row->FR_NAME; ?>"
																data-su_phone="<?php echo $data_row->FR_PHONE; ?>"
																data-su_email="<?php echo $data_row->FR_EMAIL; ?>"
																data-su_address="<?php echo $data_row->FR_ADDRESS; ?>"
																...
																data-sd_id="<?php echo $data_row->FR_ID; ?>"
							...
							<div class="row">
								<div class="col-xs-12">
									<form action="<?php echo site_url('C_md_forwarder/data_download'); ?>" method="post" enctype="multipart/form-data">
	...
	<div id="modal-form-new" class="modal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form-horizontal" action="<?php echo site_url('C_md_forwarder/data_insert'); ?>" method="post" enctype="multipart/form-data">
	...
	<div id="modal-form-update" class="modal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form-horizontal" action="<?php echo site_url('C_md_forwarder/data_update'); ?>" method="post" enctype="multipart/form-data">
	...
	<div id="modal-form-delete" class="modal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form-horizontal" action="<?php echo site_url('C_md_forwarder/data_delete'); ?>" method="post" enctype="multipart/form-data">
