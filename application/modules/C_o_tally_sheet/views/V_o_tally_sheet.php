				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<form action="<?php echo site_url('o_tally_sheet'); ?>" method="post" enctype="multipart/form-data">
										...
										<div class="row">
											<div class="col-xs-12">
												...
												<div class="col-xs-12 col-sm-4">
													...
													<br />
													Distributor : <?php echo "(".$DR_ID.")"." ".$DR_NAME; ?>
													<br />
																...
																<table id="tb_item" name="tb_item" class="table table-striped table-bordered">
																	...
																	<tbody>
																		...
																		<?php
																				...
																				$sum_weight+=($PT_WEIGHT*$si_product_detail_qty);
																				$sum_volume+=($PT_VOLUME*$si_product_detail_qty);
																			}
																		}
																		?>
																		<!------------------------------------------------------------------------------------------------->
