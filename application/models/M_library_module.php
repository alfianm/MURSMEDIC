...
class M_library_module extends CI_Model {
	...
	//-----------------------------------------------------------------------------------------------//
	//-----------------------------------------------------------------------------------------------//
	public $WEB_TITLE = "MURSMEDIC";
	public $WEB_ICON = "icon_ico.ico";
	//-----------------------------------------------------------------------------------------------//
	//-----------------------------------------------------------------------------------------------//
	//-----------------------------------------------------------------------------------------------//
	//-----------------------------------------------------------------------------------------------//
	...
	//-----------------------------------------------------------------------------------------------//
	public function GENERATOR_REFF_10(){
		$result = "";
		try{
			$result = rand(11111,99999);
		}catch(Exception $exc){
			$error = $exc->getMessage();
			echo "[ERROR][M_LIBRARY_MODULE][GENERATOR_REFF_6]".$error;
		}
		return $result;
	}
	//-----------------------------------------------------------------------------------------------//
	public function GENERATOR_REFF_12(){
		$result = "";
		try{
			$result = rand(111111,999999);
		}catch(Exception $exc){
			$error = $exc->getMessage();
			echo "[ERROR][M_LIBRARY_MODULE][GENERATOR_REFF_12]".$error;
		}
		return $result;
	}
	//-----------------------------------------------------------------------------------------------//
	public function GENERATOR_DN_NUMBER(){
		$result = "";
		try{
			//MM/DN/bulan romawi(V)/2018/counter(001)
			$result = "MM"."/"."DN"."/".date('m')."/".date('Y')."/".rand(111,999);
		}catch(Exception $exc){
			$error = $exc->getMessage();
			echo "[ERROR][M_LIBRARY_MODULE][GENERATOR_DN_NUMBER]".$error;
		}
		return $result;
	}
	//-----------------------------------------------------------------------------------------------//
	//IN/date(DDMMYY)/0000
	public function GENERATOR_DOCID_INBOUND(){
		$result = "";
		try{
			$result = "IN"."/".date('dmy')."/".rand(1111,9999);
		}catch(Exception $exc){
			$error = $exc->getMessage();
			echo "[ERROR][M_LIBRARY_MODULE][GENERATOR_DOCID_INBOUND]".$error;
		}
		return $result;
	}
	//-----------------------------------------------------------------------------------------------//
	//OUT/date(DDMMYY)/0000
	public function GENERATOR_DOCID_OUTBOUND(){
		$result = "";
		try{
			$result = "OUT"."/".date('dmy')."/".rand(1111,9999);
		}catch(Exception $exc){
			$error = $exc->getMessage();
			echo "[ERROR][M_LIBRARY_MODULE][GENERATOR_DOCID_OUTBOUND]".$error;
		}
		return $result;
	}
	//-----------------------------------------------------------------------------------------------//
